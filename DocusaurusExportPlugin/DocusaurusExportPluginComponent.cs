...
namespace DocusaurusExportPlugin
{
    ...
    public class DocusaurusExportPluginComponent : BuildComponentCore
    {
        ...
        [BuildComponentExport("DocusaurusExportPlugin", IsVisible = true, Version = AssemblyInfo.ProductVersion,
          Copyright = AssemblyInfo.Copyright, Description = "DocusaurusExportPlugin build component")]
        public sealed class Factory : BuildComponentFactory
        {
            ...
            {
                return new DocusaurusExportPluginComponent(this.BuildAssembler);
            }
...
<itemTwo value=""Test #2"" />";
        ...
        protected DocusaurusExportPluginComponent(IBuildAssembler buildAssembler) : base(buildAssembler)
        {
        }
        #endregion
        ...
        public override void Apply(XmlDocument document, string key)
        {
            ...
            this.WriteMessage(MessageLevel.Diagnostic, "In DocusaurusExportPluginComponent Apply() method");
        }
        #endregion
    }
}
