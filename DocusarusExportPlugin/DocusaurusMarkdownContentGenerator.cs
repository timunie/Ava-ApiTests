...
namespace DocusarusExportPlugin
{
    ...
    /// </summary>
    public class DocusaurusMarkdownContentGenerator
    {
        ...
        private static readonly Regex reAddNewLinesAfter = new Regex(@"(/(p|div|h[1-6]|blockquote|pre|table|tr|dl|" +
            "ol|ul|address|script|noscript|form|fieldset|iframe|math|article|aside|canvas|details|dialog|" +
        ...
        public DocusaurusMarkdownContentGenerator(BuildProcess buildProcess)
        {
        ...
        public bool Execute()
        {
            ...
            RecursiveCopy(workingFolder, buildProcess.OutputFolder, ref fileCount);
