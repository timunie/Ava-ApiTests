...
namespace DocusarusExportPlugin
{
    /// <summary>
    ...
    [HelpFileBuilderPlugInExport("DocusarusExportPlugin", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "DocusarusExportPlugin plug-in")]
    public sealed class DocusarusExportPluginPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In DocusarusExportPluginPlugIn Execute() method");

            new DocusaurusMarkdownContentGenerator(builder).Execute();
        }
        #endregion
