...
namespace DocusaurusPresentationStyle
{
    /// <summary>
    ...
    public class DocusaurusPresentationStyleComponent : BuildComponentCore
    {
        ...
        [BuildComponentExport("DocusaurusPresentationStyle", IsVisible = true, Version = AssemblyInfo.ProductVersion,
          Copyright = AssemblyInfo.Copyright, Description = "DocusaurusPresentationStyle build component")]
        public sealed class Factory : BuildComponentFactory
        {
            ...
            {
                return new DocusaurusPresentationStyleComponent(this.BuildAssembler);
            }
...
<itemTwo value=""Test #2"" />";
        ...
        protected DocusaurusPresentationStyleComponent(IBuildAssembler buildAssembler) : base(buildAssembler)
        {
        }
        #endregion
        ...
        public override void Apply(XmlDocument document, string key)
        {
            ...
            this.WriteMessage(MessageLevel.Diagnostic, "In DocusaurusPresentationStyleComponent Apply() method");
        }
        #endregion
    }
}
