...
```vb
Public Shared ReadOnly SelectionModeProperty As StyledProperty(Of DataGridSelectionMode)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val SelectionModeProperty: StyledProperty<DataGridSelectionMode>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_StyledProperty_1">StyledProperty</a>(<a href="T_Avalonia_Controls_DataGridSelectionMode">DataGridSelectionMode</a>)
