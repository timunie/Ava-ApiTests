...
Color for <a href="P_Avalonia_LinuxFramebuffer_DrmOutputOptions_EnableInitialBufferSwapping">EnableInitialBufferSwapping</a> Default: R0 G0 B0 A0
...
```vb
Public Property InitialBufferSwappingColor As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member InitialBufferSwappingColor : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/DrmOutputOptions.cs#L26" title="View the source code">View Source</a>
