...
Defines the <a href="P_Avalonia_Controls_SplitView_CompactPaneLength">CompactPaneLength</a> property
...
```vb
Public Shared ReadOnly CompactPaneLengthProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CompactPaneLengthProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
