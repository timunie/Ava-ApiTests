...
```fsharp
abstract ViewModel : Object with get, set
override ViewModel : Object with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.ReactiveUI/ViewModelViewHost.cs#L54" title="View the source code">View Source</a>
