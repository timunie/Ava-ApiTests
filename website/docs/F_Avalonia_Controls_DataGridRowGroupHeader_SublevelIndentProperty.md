...
```vb
Public Shared ReadOnly SublevelIndentProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val SublevelIndentProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
