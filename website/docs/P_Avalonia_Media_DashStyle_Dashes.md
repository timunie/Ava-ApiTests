...
```vb
Public Property Dashes As AvaloniaList(Of Double)
	Get
	Set
```
</TabItem>
...
```fsharp
member Dashes : AvaloniaList<float> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/DashStyle.cs#L89" title="View the source code">View Source</a>
