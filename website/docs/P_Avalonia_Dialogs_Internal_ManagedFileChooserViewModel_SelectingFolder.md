...
```vb
Public ReadOnly Property SelectingFolder As Boolean
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member SelectingFolder : bool with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Dialogs/Internal/ManagedFileChooserViewModel.cs#L58" title="View the source code">View Source</a>
