...
Occurs when the <a href="P_Avalonia_Controls_Utils_SelectingItemsControlSelectionAdapter_SelectedItem">SelectedItem</a> property value changes.
...
override SelectionChanged : IEvent<EventHandler<SelectionChangedEventArgs>,
    SelectionChangedEventArgs>
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/Utils/SelectingItemsControlSelectionAdapter.cs" title="View the source code">View Source</a>
...
#### Implements
<a href="E_Avalonia_Controls_Utils_ISelectionAdapter_SelectionChanged">ISelectionAdapter.SelectionChanged</a>  
