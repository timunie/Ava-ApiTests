...
```csharp
public IList<string> GlxRendererBlacklist { get; set; }
```
</TabItem>
<TabItem value="vb" label="VB">
```vb
Public Property GlxRendererBlacklist As IList(Of String)
	Get
	Set
```
</TabItem>
...
```fsharp
member GlxRendererBlacklist : IList<string> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.X11/X11Platform.cs#L343" title="View the source code">View Source</a>
