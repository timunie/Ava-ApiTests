...
```vb
<AttributeUsageAttribute(AttributeTargets.Property)>
Public NotInheritable Class ContentAttribute
	Inherits Attribute
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Metadata/ContentAttribute.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.attribute" target="_blank" rel="noopener noreferrer">Attribute</a>  →  ContentAttribute</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Metadata_ContentAttribute__ctor">ContentAttribute()</a></td>
<td>Initializes a new instance of the ContentAttribute class</td>
</tr>
</table>
