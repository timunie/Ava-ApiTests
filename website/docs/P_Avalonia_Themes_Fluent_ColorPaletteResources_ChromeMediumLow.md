...
```vb
Public Property ChromeMediumLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeMediumLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L132" title="View the source code">View Source</a>
