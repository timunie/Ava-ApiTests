...
```vb
Protected Overridable Sub OnCurrentCellChanged ( 
	e As EventArgs
)
```
</TabItem>
...
```fsharp
abstract OnCurrentCellChanged : 
        e : EventArgs -> unit 
override OnCurrentCellChanged : 
        e : EventArgs -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/DataGrid.cs#L2292" title="View the source code">View Source</a>
