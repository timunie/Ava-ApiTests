...
```fsharp
abstract DefaultTextRunProperties : TextRunProperties with get
override DefaultTextRunProperties : TextRunProperties with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/GenericTextParagraphProperties.cs#L124" title="View the source code">View Source</a>
