...
```vb
Public Property Tiling As UInteger
		Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanImageInfo.cs#L9" title="View the source code">View Source</a>
