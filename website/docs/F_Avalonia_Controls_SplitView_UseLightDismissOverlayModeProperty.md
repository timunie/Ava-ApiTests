...
Defines the <a href="P_Avalonia_Controls_SplitView_UseLightDismissOverlayMode">UseLightDismissOverlayMode</a> property
...
```vb
Public Shared ReadOnly UseLightDismissOverlayModeProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val UseLightDismissOverlayModeProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
