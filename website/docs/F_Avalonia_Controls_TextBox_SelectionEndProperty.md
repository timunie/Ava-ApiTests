...
Defines the <a href="P_Avalonia_Controls_TextBox_SelectionEnd">SelectionEnd</a> property
...
```vb
Public Shared ReadOnly SelectionEndProperty As StyledProperty(Of Integer)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val SelectionEndProperty: StyledProperty<int>
```
</TabItem>
</Tabs>
