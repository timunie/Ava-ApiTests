...
```csharp
public static void RemoveTappedHandler(
	Interactive element,
...
```vb
Public Shared Sub RemoveTappedHandler ( 
...
```fsharp
static member RemoveTappedHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L175" title="View the source code">View Source</a>
