...
```vb
Public Shared ReadOnly PointerTouchPadGestureSwipeEvent As RoutedEvent(Of PointerDeltaEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val PointerTouchPadGestureSwipeEvent: RoutedEvent<PointerDeltaEventArgs>
```
</TabItem>
</Tabs>
