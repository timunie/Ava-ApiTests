...
```vb
Public ReadOnly Property SizeMm As Size
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member SizeMm : Size with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/Output/DrmBindings.cs#L25" title="View the source code">View Source</a>
