...
```vb
Public Property UsageFlags As UInteger
		Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanImageInfo.cs#L10" title="View the source code">View Source</a>
