...
```vb
Public Property Closed As Action
	Get
	Set
```
</TabItem>
...
override Closed : Action with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Embedding/Offscreen/OffscreenTopLevelImpl.cs#L79" title="View the source code">View Source</a>
...
#### Implements
<a href="P_Avalonia_Platform_ITopLevelImpl_Closed">ITopLevelImpl.Closed</a>  
