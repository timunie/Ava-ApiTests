...
```vb
Public Property Container2Width As Double
	Get
	Set
```
</TabItem>
...
```fsharp
member Container2Width : float with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/ProgressBar.cs#L127" title="View the source code">View Source</a>
