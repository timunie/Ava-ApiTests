...
```vb
Public Property AltLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member AltLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L32" title="View the source code">View Source</a>
