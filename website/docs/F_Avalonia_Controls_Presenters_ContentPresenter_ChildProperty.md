...
Defines the <a href="P_Avalonia_Controls_Presenters_ContentPresenter_Child">Child</a> property.
...
```vb
Public Shared ReadOnly ChildProperty As DirectProperty(Of ContentPresenter, Control)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ChildProperty: DirectProperty<ContentPresenter, Control>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_DirectProperty_2">DirectProperty</a>(<a href="T_Avalonia_Controls_Presenters_ContentPresenter">ContentPresenter</a>, <a href="T_Avalonia_Controls_Control">Control</a>)
