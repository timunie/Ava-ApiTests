...
Represents a button on a <a href="T_Avalonia_Controls_Calendar">Calendar</a>.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_CalendarButton__ctor">CalendarButton()</a></td>
<td>Initializes a new instance of the CalendarButton class.</td>
</tr>
</table>
...
<tr>
<td><a href="E_Avalonia_Controls_Primitives_CalendarButton_CalendarLeftMouseButtonDown">CalendarLeftMouseButtonDown</a></td>
<td>Occurs when the left mouse button is pressed (or when the tip of the stylus touches the tablet PC) while the mouse pointer is over a UIElement.</td>
</tr>
<tr>
<td><a href="E_Avalonia_Controls_Primitives_CalendarButton_CalendarLeftMouseButtonUp">CalendarLeftMouseButtonUp</a></td>
<td>Occurs when the left mouse button is released (or the tip of the stylus is removed from the tablet PC) while the mouse (or the stylus) is over a UIElement (or while a UIElement holds mouse capture).</td>
</tr>
<tr>
