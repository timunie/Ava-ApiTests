...
Sets the <a href="T_Avalonia_Controls_WindowTransparencyLevel">WindowTransparencyLevel</a> hint of the TopLevel.
...
```vb
Sub SetTransparencyLevelHint ( 
	transparencyLevels As IReadOnlyList(Of WindowTransparencyLevel)
)
```
</TabItem>
...
abstract SetTransparencyLevelHint : 
        transparencyLevels : IReadOnlyList<WindowTransparencyLevel> -> unit 
```
</TabItem>
</Tabs>
