...
<td><br />(Overrides <a href="M_Avalonia_Controls_Control_OnKeyUp">Control.OnKeyUp(KeyEventArgs)</a>)</td>
</tr>
<tr>
...
<td><br />(Overrides InputElement.OnPointerCaptureLost(PointerCaptureLostEventArgs))</td>
</tr>
<tr>
