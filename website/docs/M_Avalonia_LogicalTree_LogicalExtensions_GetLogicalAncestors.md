...
Enumerates the ancestors of an <a href="T_Avalonia_LogicalTree_ILogical">ILogical</a> in the logical tree.
...
```csharp
public static IEnumerable<ILogical> GetLogicalAncestors(
...
```vb
<ExtensionAttribute>
Public Shared Function GetLogicalAncestors ( 
	logical As ILogical
...
```fsharp
[<ExtensionAttribute>]
static member GetLogicalAncestors : 
