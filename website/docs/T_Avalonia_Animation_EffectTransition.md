# EffectTransition Class


Transition class that handles <a href="T_Avalonia_AvaloniaProperty">AvaloniaProperty</a> with <a href="T_Avalonia_Media_IEffect">IEffect</a> type.
...
Public Class EffectTransition
	Inherits Transition(Of IEffect)
```
</TabItem>
...
<table>
<tr>
<td><a href="M_Avalonia_Animation_EffectTransition__ctor">EffectTransition()</a></td>
<td>Initializes a new instance of the EffectTransition class</td>
</tr>
</table>
