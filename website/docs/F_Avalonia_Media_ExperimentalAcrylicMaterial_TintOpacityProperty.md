...
Defines the <a href="P_Avalonia_Media_ExperimentalAcrylicMaterial_TintOpacity">TintOpacity</a> property.
...
```vb
Public Shared ReadOnly TintOpacityProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val TintOpacityProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
