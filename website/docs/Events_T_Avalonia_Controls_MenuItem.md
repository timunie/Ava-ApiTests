...
<td>Occurs when a <a href="T_Avalonia_Controls_MenuItem">MenuItem</a> without a submenu is clicked.</td>
</tr>
<tr>
...
<td>Occurs when a <a href="T_Avalonia_Controls_MenuItem">MenuItem</a>'s submenu is opened.</td>
</tr>
<tr>
<td>Tapped</td>
<td><br />(Inherited from InputElement)</td>
