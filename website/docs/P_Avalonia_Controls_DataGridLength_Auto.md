...
Gets a <a href="T_Avalonia_Controls_DataGridLength">DataGridLength</a> structure that represents the standard automatic sizing mode.
...
A <a href="T_Avalonia_Controls_DataGridLength">DataGridLength</a> structure that represents the standard automatic sizing mode.
