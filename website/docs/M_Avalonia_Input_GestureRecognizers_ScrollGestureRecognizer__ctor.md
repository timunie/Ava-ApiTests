...
Initializes a new instance of the <a href="T_Avalonia_Input_GestureRecognizers_ScrollGestureRecognizer">ScrollGestureRecognizer</a> class
...
```fsharp
new : unit -> ScrollGestureRecognizer
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/GestureRecognizers/ScrollGestureRecognizer.cs#L18" title="View the source code">View Source</a>
