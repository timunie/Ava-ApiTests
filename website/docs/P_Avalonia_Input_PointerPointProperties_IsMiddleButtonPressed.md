...
```fsharp
member IsMiddleButtonPressed : bool with 
		get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/PointerPoint.cs#L46" title="View the source code">View Source</a>
