...
Public Sub ScrollDown ( 
	Optional numItems As Integer = 1
)
```
</TabItem>
...
member ScrollDown : 
        ?numItems : int 
(* Defaults:
        let _numItems = defaultArg numItems 1
*)
-> unit 
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/DateTimePickers/DateTimePickerPanel.cs#L411" title="View the source code">View Source</a>
