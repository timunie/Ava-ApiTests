...
```vb
<ContentAttribute>
Public ReadOnly Property Items As IList(Of NativeMenuItemBase)
	Get
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/NativeMenu.cs#L20" title="View the source code">View Source</a>
