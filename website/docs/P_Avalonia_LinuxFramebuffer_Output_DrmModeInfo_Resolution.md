...
```vb
Public ReadOnly Property Resolution As PixelSize
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member Resolution : PixelSize with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/Output/DrmBindings.cs#L63" title="View the source code">View Source</a>
