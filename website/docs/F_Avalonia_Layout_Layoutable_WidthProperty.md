...
Defines the <a href="P_Avalonia_Layout_Layoutable_Width">Width</a> property.
...
```vb
Public Shared ReadOnly WidthProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val WidthProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
