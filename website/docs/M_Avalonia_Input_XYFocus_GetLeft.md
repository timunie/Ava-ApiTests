...
```csharp
public static InputElement GetLeft(
	InputElement obj
)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Navigation/XYFocus.Properties.cs#L17" title="View the source code">View Source</a>
