...
```vb
Public Shared Function CreateFromEnvironment As EvDevBackend
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static member CreateFromEnvironment : unit -> EvDevBackend 
```
</TabItem>
</Tabs>
...
#### Return Value
<a href="T_Avalonia_LinuxFramebuffer_Input_EvDev_EvDevBackend">EvDevBackend</a>
