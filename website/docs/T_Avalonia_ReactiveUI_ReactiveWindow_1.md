...
A ReactiveUI <a href="T_Avalonia_Controls_Window">Window</a> that implements the IViewFor interface and will activate your ViewModel automatically if the view model implements IActivatableViewModel. When the DataContext property changes, this class will update the ViewModel property with the new DataContext value, and vice versa.
...
```csharp
public class ReactiveWindow<TViewModel> : Window, 
...
```vb
Public Class ReactiveWindow(Of TViewModel As Class)
	Inherits Window
	Implements IViewFor(Of TViewModel), IViewFor, 
	IActivatableView
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
type ReactiveWindow<'TViewModel when 'TViewModel : not struct> = 
    class
        inherit Window
...
<td>Enables or disables resizing of the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets or sets a value indicating how the <a href="E_Avalonia_Controls_Window_Closing">Closing</a> event behaves in the presence of child windows.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets or Sets the <a href="T_Avalonia_Platform_ExtendClientAreaChromeHints">ExtendClientAreaChromeHints</a> that control how the chrome looks when the client area is extended.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Window_ExtendClientAreaTitleBarHeightHint">ExtendClientAreaTitleBarHeightHint</a></td>
<td>Gets or Sets the TitlebarHeightHint for when the client area is extended. A value of -1 will cause the titlebar to be auto sized to the OS default. Any other positive value will cause the titlebar to assume that height.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Window_ExtendClientAreaToDecorationsHint">ExtendClientAreaToDecorationsHint</a></td>
<td>Gets or sets if the ClientArea is Extended into the Window Decorations (chrome or border).<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets or sets the icon of the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets if the ClientArea is Extended into the Window Decorations.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets a collection of child windows owned by this window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets or sets the window position in screen coordinates.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets or sets a value that indicates whether a window is activated when first shown.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Window_ShowInTaskbar">ShowInTaskbar</a></td>
<td>Enables or disables the taskbar icon<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Window_SizeToContent">SizeToContent</a></td>
<td>Gets or sets a value indicating how the window will size itself to fit its content.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets the type by which the element is styled.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Sets the system decorations (title bar, border, etc)<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Gets or sets the title of the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_ReactiveUI_ReactiveWindow_1_ViewModel">ViewModel</a></td>
<td>The ViewModel.</td>
</tr>
<tr>
...
<td>Gets the WindowDecorationMargin. This tells you the thickness around the window that is used by borders and the titlebar.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Window_WindowStartupLocation">WindowStartupLocation</a></td>
<td>Gets or sets the startup location of the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Window_WindowState">WindowState</a></td>
<td>Gets or sets the minimized/maximized state of the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td><br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Starts moving a window with left button being held. Should be called from left mouse button press event handler<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_Window_BeginResizeDrag">BeginResizeDrag(WindowEdge, PointerPressedEventArgs)</a></td>
<td>Starts resizing a window. This function is used if an application has window resizing controls. Should be called from left mouse button press event handler<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Closes the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_Window_Close_1">Close(Object)</a></td>
<td>Closes a dialog window with the specified result.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Hides the window but does not close it.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Called when the control is added to a rooted visual tree.<br />(Inherited from <a href="T_Avalonia_Controls_TopLevel">TopLevel</a>)</td>
</tr>
<tr>
...
<td>Raises the <a href="E_Avalonia_Controls_Window_Closing">Closing</a> event.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_ReactiveUI_ReactiveWindow_1_OnPropertyChanged">OnPropertyChanged(AvaloniaPropertyChangedEventArgs)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Controls_Window_OnPropertyChanged">Window.OnPropertyChanged(AvaloniaPropertyChangedEventArgs)</a>)</td>
</tr>
<tr>
...
<td>Shows the window.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_Window_Show_1">Show(Window)</a></td>
<td>Shows the window as a child of <em>owner</em>.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_Window_ShowDialog">ShowDialog(Window)</a></td>
<td>Shows the window as a dialog.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
...
<td>Fired before a window is closed.<br />(Inherited from <a href="T_Avalonia_Controls_Window">Window</a>)</td>
</tr>
<tr>
