...
Defines the <a href="P_Avalonia_Controls_ProgressBar_ProgressBarTemplateSettings_IndeterminateStartingOffset">IndeterminateStartingOffset</a> property.
...
```vb
Public Shared ReadOnly IndeterminateStartingOffsetProperty As DirectProperty(Of ProgressBar.ProgressBarTemplateSettings, Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IndeterminateStartingOffsetProperty: DirectProperty<ProgressBar.ProgressBarTemplateSettings, float>
```
</TabItem>
</Tabs>
