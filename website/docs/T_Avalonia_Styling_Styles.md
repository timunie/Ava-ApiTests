...
Public Class Styles
	...
	Implements IAvaloniaList(Of IStyle), IList(Of IStyle), 
	ICollection(Of IStyle), IEnumerable(Of IStyle), IEnumerable, 
	IAvaloniaReadOnlyList(Of IStyle), IReadOnlyList(Of IStyle), IReadOnlyCollection(Of IStyle), 
	INotifyCollectionChanged, INotifyPropertyChanged, IStyle, IResourceNode, IResourceProvider
```
</TabItem>
...
type Styles = 
    class
        ...
        interface IAvaloniaList<IStyle>
        interface IList<IStyle>
        interface ICollection<IStyle>
        interface IEnumerable<IStyle>
        interface IEnumerable
        interface IAvaloniaReadOnlyList<IStyle>
        interface IReadOnlyList<IStyle>
        interface IReadOnlyCollection<IStyle>
...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_AvaloniaObject">AvaloniaObject</a>  →  Styles</td></tr>
<tr><td><strong>Implements</strong></td><td><a href="T_Avalonia_Collections_IAvaloniaList_1">IAvaloniaList</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="T_Avalonia_Collections_IAvaloniaReadOnlyList_1">IAvaloniaReadOnlyList</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="T_Avalonia_Controls_IResourceNode">IResourceNode</a>, <a href="T_Avalonia_Controls_IResourceProvider">IResourceProvider</a>, <a href="T_Avalonia_Styling_IStyle">IStyle</a>, <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1" target="_blank" rel="noopener noreferrer">ICollection</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1" target="_blank" rel="noopener noreferrer">IList</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlycollection-1" target="_blank" rel="noopener noreferrer">IReadOnlyCollection</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlylist-1" target="_blank" rel="noopener noreferrer">IReadOnlyList</a>(<a href="T_Avalonia_Styling_IStyle">IStyle</a>), <a href="https://learn.microsoft.com/dotnet/api/system.collections.ienumerable" target="_blank" rel="noopener noreferrer">IEnumerable</a>, <a href="https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged" target="_blank" rel="noopener noreferrer">INotifyCollectionChanged</a>, <a href="https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged" target="_blank" rel="noopener noreferrer">INotifyPropertyChanged</a></td></tr>
</table>
...
<td>Initializes a new instance of the Styles class</td>
</tr>
<tr>
...
<table>
<tr>
<td><a href="P_Avalonia_Styling_Styles_Count">Count</a></td>
<td> </td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Styling_Styles_Item">Item(Int32)</a></td>
<td> </td>
</tr>
<tr>
<td><a href="P_Avalonia_Styling_Styles_Owner">Owner</a></td>
<td> </td>
</tr>
<tr>
<td><a href="P_Avalonia_Styling_Styles_Resources">Resources</a></td>
<td>Gets or sets a dictionary of style resources.</td>
</tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Styling_Styles_Add">Add(IStyle)</a></td>
<td>Adds an item to the <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1" target="_blank" rel="noopener noreferrer">ICollection(T)</a>.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_AddRange">AddRange(IEnumerable(IStyle))</a></td>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_Clear">Clear()</a></td>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_Contains">Contains(IStyle)</a></td>
<td>Determines whether the <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1" target="_blank" rel="noopener noreferrer">ICollection(T)</a> contains a specific value.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_CopyTo">CopyTo(IStyle[], Int32)</a></td>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_GetEnumerator">GetEnumerator()</a></td>
<td> </td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_IndexOf">IndexOf(IStyle)</a></td>
<td>Determines the index of a specific item in the <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1" target="_blank" rel="noopener noreferrer">IList(T)</a>.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_Insert">Insert(Int32, IStyle)</a></td>
<td>Inserts an item to the <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1" target="_blank" rel="noopener noreferrer">IList(T)</a> at the specified index.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_InsertRange">InsertRange(Int32, IEnumerable(IStyle))</a></td>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_Move">Move(Int32, Int32)</a></td>
<td>Moves an item to a new index.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_MoveRange">MoveRange(Int32, Int32, Int32)</a></td>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_Remove">Remove(IStyle)</a></td>
<td>Removes the first occurrence of a specific object from the <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1" target="_blank" rel="noopener noreferrer">ICollection(T)</a>.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_RemoveAll">RemoveAll(IEnumerable(IStyle))</a></td>
<td>Removes multiple items from the collection.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_RemoveAt">RemoveAt(Int32)</a></td>
<td>Removes the <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1" target="_blank" rel="noopener noreferrer">IList(T)</a> item at the specified index.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Styling_Styles_RemoveRange">RemoveRange(Int32, Int32)</a></td>
...
<tr>
<td><a href="M_Avalonia_Styling_Styles_TryGetResource">TryGetResource(Object, ThemeVariant, Object)</a></td>
...
<table>
<tr>
<td><a href="E_Avalonia_Styling_Styles_CollectionChanged">CollectionChanged</a></td>
<td> </td>
</tr>
<tr>
<td><a href="E_Avalonia_Styling_Styles_OwnerChanged">OwnerChanged</a></td>
<td> </td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Collections_AvaloniaListExtensions_ForEachItem__1">ForEachItem(IStyle)(Action(IStyle), Action(IStyle), Action, Boolean)</a></td>
...
<tr>
<td><a href="M_Avalonia_Collections_AvaloniaListExtensions_ForEachItem__1_1">ForEachItem(IStyle)(Action(Int32, IStyle), Action(Int32, IStyle), Action, Boolean)</a></td>
<td>Invokes an action for each item in a collection and subsequently each item added or removed from the collection.<br />(Defined by <a href="T_Avalonia_Collections_AvaloniaListExtensions">AvaloniaListExtensions</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Collections_AvaloniaListExtensions_TrackItemPropertyChanged__1">TrackItemPropertyChanged(IStyle)(Action(Tuple(Object, PropertyChangedEventArgs)))</a></td>
