...
```vb
Public Structure SplitResult(Of T)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/SplitResult.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.valuetype" target="_blank" rel="noopener noreferrer">ValueType</a>  →  SplitResult(T)</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Media_TextFormatting_SplitResult_1__ctor">SplitResult(T)(T, T)</a></td>
<td>Initializes a new instance of the SplitResult(T) class</td>
</tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Media_TextFormatting_SplitResult_1_Deconstruct">Deconstruct(T, T)</a></td>
<td>Deconstructs the split results into its components.</td>
</tr>
<tr>
