...
# ReversibleStackPanel Class


Implements a <a href="T_Avalonia_Controls_StackPanel">StackPanel</a> where the flow direction of its items can be reversed.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_ReversibleStackPanel__ctor">ReversibleStackPanel()</a></td>
<td>Initializes a new instance of the ReversibleStackPanel class</td>
</tr>
</table>
...
<tr>
<td><a href="P_Avalonia_Controls_StackPanel_AreHorizontalSnapPointsRegular">AreHorizontalSnapPointsRegular</a></td>
<td>Gets or sets whether the horizontal snap points for the <a href="T_Avalonia_Controls_StackPanel">StackPanel</a> are equidistant from each other.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_StackPanel_AreVerticalSnapPointsRegular">AreVerticalSnapPointsRegular</a></td>
<td>Gets or sets whether the vertical snap points for the <a href="T_Avalonia_Controls_StackPanel">StackPanel</a> are equidistant from each other.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Controls_StackPanel_Orientation">Orientation</a></td>
<td>Gets or sets the orientation in which child controls will be layed out.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
<td>Parent</td>
<td><br />(Inherited from StyledElement)</td>
...
<tr>
<td><a href="P_Avalonia_Controls_ReversibleStackPanel_ReverseOrder">ReverseOrder</a></td>
<td>Gets or sets if the child controls will be layed out in reverse order.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_StackPanel_Spacing">Spacing</a></td>
<td>Gets or sets the size of the spacing to place between child controls.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
<td>StyleKey</td>
<td><br />(Inherited from StyledElement)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_ReversibleStackPanel_ArrangeOverride">ArrangeOverride(Size)</a></td>
<td>Content arrangement.<br />(Overrides <a href="M_Avalonia_Controls_StackPanel_ArrangeOverride">StackPanel.ArrangeOverride(Size)</a>)</td>
</tr>
<tr>
<td>BeginInit()</td>
<td><br />(Inherited from StyledElement)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_StackPanel_GetControlInDirection">GetControlInDirection(NavigationDirection, Control)</a></td>
<td>Gets the next control in the specified direction.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
<td>GetHashCode()</td>
<td><br />(Inherited from AvaloniaObject)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_StackPanel_GetIrregularSnapPoints">GetIrregularSnapPoints(Orientation, SnapPointsAlignment)</a></td>
<td>Returns the set of distances between irregular snap points for a specified orientation and alignment.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_StackPanel_GetRegularSnapPoints">GetRegularSnapPoints(Orientation, SnapPointsAlignment, Double)</a></td>
<td>Gets the distance between regular snap points for a specified orientation and alignment.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_StackPanel_MeasureOverride">MeasureOverride(Size)</a></td>
<td>General StackPanel layout behavior is to grow unbounded in the "stacking" direction (Size To Content). Children in this dimension are encouraged to be as large as they like. In the other dimension, StackPanel will assume the maximum size of its children.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="E_Avalonia_Controls_StackPanel_HorizontalSnapPointsChanged">HorizontalSnapPointsChanged</a></td>
<td>Occurs when the measurements for horizontal snap points change.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
<tr>
<td>Initialized</td>
<td><br />(Inherited from StyledElement)</td>
...
<tr>
<td><a href="E_Avalonia_Controls_StackPanel_VerticalSnapPointsChanged">VerticalSnapPointsChanged</a></td>
<td>Occurs when the measurements for vertical snap points change.<br />(Inherited from <a href="T_Avalonia_Controls_StackPanel">StackPanel</a>)</td>
</tr>
</table>
