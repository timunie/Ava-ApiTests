...
```csharp
public ReadOnlySpan<char> TakeUntil(
	char c
)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Utilities/CharacterReader.cs#L62" title="View the source code">View Source</a>
