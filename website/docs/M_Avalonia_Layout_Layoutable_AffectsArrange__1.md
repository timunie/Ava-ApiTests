...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Layout/Layoutable.cs#L511" title="View the source code">View Source</a>
...
## Remarks
After a call to this method in a control's static constructor, any change to the property will cause <a href="M_Avalonia_Layout_Layoutable_InvalidateArrange">InvalidateArrange()</a> to be called on the element.
