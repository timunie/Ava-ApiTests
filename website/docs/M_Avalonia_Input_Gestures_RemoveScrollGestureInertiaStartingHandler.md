# RemoveScrollGestureInertiaStartingHandler Method
...
```csharp
public static void RemoveScrollGestureInertiaStartingHandler(
	Interactive element,
...
```vb
Public Shared Sub RemoveScrollGestureInertiaStartingHandler ( 
...
```fsharp
static member RemoveScrollGestureInertiaStartingHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L219" title="View the source code">View Source</a>
