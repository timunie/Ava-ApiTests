...
```vb
Public Property ChromeAltLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeAltLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L77" title="View the source code">View Source</a>
