...
```csharp
protected override Control? ScrollIntoView(
	int index
)
```
</TabItem>
...
```vb
Protected Overrides Function ScrollIntoView ( 
	index As Integer
) As Control
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/VirtualizingCarouselPanel.cs#L200" title="View the source code">View Source</a>
