...
```vb
Public Property ChromeBlackMedium As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeBlackMedium : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L92" title="View the source code">View Source</a>
