...
```vb
Public Shared ReadOnly ExtendClientAreaTitleBarHeightHintProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ExtendClientAreaTitleBarHeightHintProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
