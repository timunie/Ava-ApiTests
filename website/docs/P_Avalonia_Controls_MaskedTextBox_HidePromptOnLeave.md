...
```fsharp
member HidePromptOnLeave : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/MaskedTextBox.cs#L122" title="View the source code">View Source</a>
