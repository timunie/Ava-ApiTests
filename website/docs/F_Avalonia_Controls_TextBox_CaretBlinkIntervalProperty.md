...
Defines the <a href="P_Avalonia_Controls_TextBox_CaretBlinkInterval">CaretBlinkInterval</a> property
...
```vb
Public Shared ReadOnly CaretBlinkIntervalProperty As StyledProperty(Of TimeSpan)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CaretBlinkIntervalProperty: StyledProperty<TimeSpan>
```
</TabItem>
</Tabs>
