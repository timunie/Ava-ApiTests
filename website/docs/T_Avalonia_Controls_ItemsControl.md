...
<tr><td><strong>Derived</strong></td><td><a href="T_Avalonia_Controls_Primitives_HeaderedItemsControl">Avalonia.Controls.Primitives.HeaderedItemsControl</a><br /><a href="T_Avalonia_Controls_Primitives_SelectingItemsControl">Avalonia.Controls.Primitives.SelectingItemsControl</a><br /><a href="T_Avalonia_Controls_TreeView">Avalonia.Controls.TreeView</a></td></tr>
<tr><td><strong>Implements</strong></td><td>IChildIndexProvider</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl__ctor">ItemsControl</a></td>
<td>Initializes a new instance of the ItemsControl class.</td>
</tr>
</table>
...
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_DefaultRecycleKey">DefaultRecycleKey</a></td>
<td>Gets a default recycle key that can be used when an ItemsControl supports a single container type.</td>
</tr>
<tr>
<td>DesiredSize</td>
...
<td>Gets or sets the IBinding to use for binding to the display member of each item.</td>
</tr>
<tr>
<td>Effect</td>
<td><br />(Inherited from Visual)</td>
...
<td>Gets the <a href="P_Avalonia_Controls_ItemsControl_ItemContainerGenerator">ItemContainerGenerator</a> for the control.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemContainerTheme">ItemContainerTheme</a></td>
<td>Gets or sets the ControlTheme that is applied to the container element generated for each item.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemCount">ItemCount</a></td>
<td>Gets the number of items being displayed by the ItemsControl.</td>
</tr>
<tr>
...
<td>Gets or sets the panel used to display the items.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemsPanelRoot">ItemsPanelRoot</a></td>
<td>Gets the <a href="T_Avalonia_Controls_Panel">Panel</a> specified by <a href="P_Avalonia_Controls_ItemsControl_ItemsPanel">ItemsPanel</a>.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemsSource">ItemsSource</a></td>
<td>Gets or sets a collection used to generate the content of the ItemsControl.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemsView">ItemsView</a></td>
<td>Gets a read-only view of the items in the ItemsControl.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemTemplate">ItemTemplate</a></td>
<td>Gets or sets the data template used to display the items in the control.</td>
</tr>
<tr>
<td>KeyBindings</td>
<td><br />(Inherited from InputElement)</td>
...
<td>Gets the items presenter control.</td>
</tr>
<tr>
<td>PseudoClasses</td>
<td><br />(Inherited from StyledElement)</td>
...
<td>Undoes the effects of the <a href="M_Avalonia_Controls_ItemsControl_PrepareContainerForItemOverride">PrepareContainerForItemOverride(Control, Object, Int32)</a> method.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl_ContainerForItemPreparedOverride">ContainerForItemPreparedOverride</a></td>
<td>Called when a container has been fully prepared to display an item.</td>
</tr>
<tr>
...
<td>Returns the container corresponding to the specified item.</td>
</tr>
<tr>
...
<td>Creates or a container that can be used to display an item.</td>
</tr>
<tr>
<td>EndInit</td>
<td><br />(Inherited from StyledElement)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl_GetNextControl">GetNextControl</a></td>
<td> </td>
</tr>
<tr>
...
<td>Returns the index to the item that has the specified, generated container.</td>
</tr>
<tr>
...
<td>Returns the item that corresponds to the specified, generated container.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl_ItemsControlFromItemContainer">ItemsControlFromItemContainer</a></td>
<td>Returns the ItemsControl that owns the specified container control.</td>
</tr>
<tr>
...
<td>A default implementation of <a href="M_Avalonia_Controls_ItemsControl_NeedsContainerOverride">NeedsContainerOverride(Object, Int32, Object)</a> that returns true and sets the recycle key to <a href="P_Avalonia_Controls_ItemsControl_DefaultRecycleKey">DefaultRecycleKey</a> if the item is not a <em>T</em> .</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl_NeedsContainerOverride">NeedsContainerOverride</a></td>
<td>Determines whether the specified item can be its own container.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl_OnApplyTemplate">OnApplyTemplate</a></td>
...
<td>Handles directional navigation within the ItemsControl.<br />(Overrides InputElement.OnKeyDown(KeyEventArgs))</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_ItemsControl_PrepareContainerForItemOverride">PrepareContainerForItemOverride</a></td>
<td>Prepares the specified element to display the specified item.</td>
</tr>
<tr>
<td>RaiseEvent</td>
<td><br />(Inherited from Interactive)</td>
...
<td>Refreshes the containers displayed by the control.</td>
</tr>
<tr>
...
<td>Occurs each time a container is cleared.</td>
</tr>
<tr>
<td><a href="E_Avalonia_Controls_ItemsControl_ContainerIndexChanged">ContainerIndexChanged</a></td>
<td>Occurs for each realized container when the index for the item it represents has changed.</td>
</tr>
<tr>
<td><a href="E_Avalonia_Controls_ItemsControl_ContainerPrepared">ContainerPrepared</a></td>
<td>Occurs each time a container is prepared for use.</td>
</tr>
<tr>
