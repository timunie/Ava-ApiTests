...
```vb
Public Shared Function GetAcceleratorKey ( 
...
```fsharp
static member GetAcceleratorKey : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Automation/AutomationProperties.cs#L205" title="View the source code">View Source</a>
