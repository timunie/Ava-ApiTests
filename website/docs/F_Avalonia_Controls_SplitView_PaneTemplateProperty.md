...
Defines the <a href="P_Avalonia_Controls_SplitView_PaneTemplate">PaneTemplate</a> property.
...
```vb
Public Shared ReadOnly PaneTemplateProperty As StyledProperty(Of IDataTemplate)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val PaneTemplateProperty: StyledProperty<IDataTemplate>
```
</TabItem>
</Tabs>
