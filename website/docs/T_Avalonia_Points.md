...
Represents a collection of <a href="T_Avalonia_Point">Point</a> values that can be individually accessed by index.
...
Public NotInheritable Class Points
	Inherits AvaloniaList(Of Point)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Points.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList</a>(<a href="T_Avalonia_Point">Point</a>)  →  Points</td></tr>
</table>
...
<td>Initializes a new instance of the Points class</td>
</tr>
<tr>
