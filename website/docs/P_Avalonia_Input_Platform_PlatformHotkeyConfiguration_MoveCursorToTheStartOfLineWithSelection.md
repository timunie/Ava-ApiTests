...
```vb
Public Property MoveCursorToTheStartOfLineWithSelection As List(Of KeyGesture)
	Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L123" title="View the source code">View Source</a>
