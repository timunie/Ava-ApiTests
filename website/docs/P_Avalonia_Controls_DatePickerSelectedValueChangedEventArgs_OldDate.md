...
```vb
Public ReadOnly Property OldDate As DateTimeOffset?
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member OldDate : Nullable<DateTimeOffset> with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/DateTimePickers/DatePickerSelectedValueChangedEventArgs.cs#L11" title="View the source code">View Source</a>
