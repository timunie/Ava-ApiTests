...
```vb
Public Shared ReadOnly ItemCountFormatProperty As StyledProperty(Of String)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ItemCountFormatProperty: StyledProperty<string>
```
</TabItem>
</Tabs>
