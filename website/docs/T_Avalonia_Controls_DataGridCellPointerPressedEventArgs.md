...
```vb
Public Class DataGridCellPointerPressedEventArgs
	Inherits EventArgs
```
</TabItem>
...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.eventargs" target="_blank" rel="noopener noreferrer">EventArgs</a>  →  DataGridCellPointerPressedEventArgs</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_DataGridCellPointerPressedEventArgs__ctor">DataGridCellPointerPressedEventArgs(DataGridCell, DataGridRow, DataGridColumn, PointerPressedEventArgs)</a></td>
