...
Defines the <a href="P_Avalonia_Controls_HyperlinkButton_IsVisited">IsVisited</a> property.
...
```vb
Public Shared ReadOnly IsVisitedProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsVisitedProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
