...
```fsharp
member NewTime : Nullable<TimeSpan> with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/DateTimePickers/TimePickerSelectedValueChangedEventArgs.cs#L8" title="View the source code">View Source</a>
