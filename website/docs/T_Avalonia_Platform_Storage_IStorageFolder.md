...
<td>Creates a file with specified name as a child of the current storage folder</td>
</tr>
<tr>
<td><a href="M_Avalonia_Platform_Storage_IStorageFolder_CreateFolderAsync">CreateFolderAsync(String)</a></td>
<td>Creates a folder with specified name as a child of the current storage folder</td>
</tr>
<tr>
...
<td>Gets the files and subfolders in the current folder.</td>
</tr>
<tr>
...
<td>Moves the current storage item and it's contents to a IStorageFolder<br />(Inherited from <a href="T_Avalonia_Platform_Storage_IStorageItem">IStorageItem</a>)</td>
</tr>
<tr>
