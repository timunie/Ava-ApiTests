...
```csharp
public static AppBuilder UseAvaloniaNative(
...
```vb
<ExtensionAttribute>
Public Shared Function UseAvaloniaNative ( 
...
```fsharp
[<ExtensionAttribute>]
static member UseAvaloniaNative : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Native/AvaloniaNativePlatformExtensions.cs#L13" title="View the source code">View Source</a>
