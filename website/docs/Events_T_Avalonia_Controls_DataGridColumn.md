...
<td>Occurs when the pointer is pressed over the column's header</td>
</tr>
<tr>
<td><a href="E_Avalonia_Controls_DataGridColumn_HeaderPointerReleased">HeaderPointerReleased</a></td>
<td>Occurs when the pointer is released over the column's header</td>
</tr>
<tr>
