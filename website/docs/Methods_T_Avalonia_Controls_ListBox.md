...
<td>Selects all items in the <a href="T_Avalonia_Controls_ListBox">ListBox</a>.</td>
</tr>
<tr>
<td>SetAndRaise``1</td>
<td><br />(Inherited from AvaloniaObject)</td>
...
<td>Deselects all items in the <a href="T_Avalonia_Controls_ListBox">ListBox</a>.</td>
</tr>
<tr>
