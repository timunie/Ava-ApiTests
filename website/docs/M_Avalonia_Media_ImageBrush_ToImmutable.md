...
```vb
Public Function ToImmutable As IImmutableBrush
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/ImageBrush.cs#L48" title="View the source code">View Source</a>
