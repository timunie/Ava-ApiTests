...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  AvaloniaObject  →  Animatable  →  StyledElement  →  TextElement</td></tr>
...
<td><br />(Overrides StyledElement.OnPropertyChanged(AvaloniaPropertyChangedEventArgs))</td>
</tr>
<tr>
