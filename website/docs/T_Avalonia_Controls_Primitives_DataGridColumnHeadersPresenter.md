# DataGridColumnHeadersPresenter Class


Used within the template of a <a href="T_Avalonia_Controls_DataGrid">DataGrid</a> to specify the location in the control's visual tree where the column headers are to be added.
...
```vb
Public NotInheritable Class DataGridColumnHeadersPresenter
	Inherits Panel
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridColumnHeadersPresenter__ctor">DataGridColumnHeadersPresenter()</a></td>
<td>Initializes a new instance of the DataGridColumnHeadersPresenter class</td>
</tr>
</table>
