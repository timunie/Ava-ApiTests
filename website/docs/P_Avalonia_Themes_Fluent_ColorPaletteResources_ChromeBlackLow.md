...
```vb
Public Property ChromeBlackLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeBlackLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L87" title="View the source code">View Source</a>
