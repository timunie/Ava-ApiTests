...
Defines the <a href="P_Avalonia_Layout_Layoutable_Height">Height</a> property.
...
```vb
Public Shared ReadOnly HeightProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val HeightProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
