...
Defines the <a href="P_Avalonia_Controls_Presenters_ScrollContentPresenter_CanVerticallyScroll">CanVerticallyScroll</a> property.
...
```vb
Public Shared ReadOnly CanVerticallyScrollProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CanVerticallyScrollProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
