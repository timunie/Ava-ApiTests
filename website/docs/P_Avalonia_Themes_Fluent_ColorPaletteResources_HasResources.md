...
```csharp
public override bool HasResources \{ get; }
```
</TabItem>
...
```fsharp
abstract HasResources : bool with get
override HasResources : bool with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.cs#L21" title="View the source code">View Source</a>
...
#### Implements
<a href="P_Avalonia_Controls_IResourceNode_HasResources">IResourceNode.HasResources</a>  
