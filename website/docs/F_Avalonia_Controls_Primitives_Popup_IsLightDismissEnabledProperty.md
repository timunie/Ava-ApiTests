...
Defines the <a href="P_Avalonia_Controls_Primitives_Popup_IsLightDismissEnabled">IsLightDismissEnabled</a> property.
...
```vb
Public Shared ReadOnly IsLightDismissEnabledProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsLightDismissEnabledProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
