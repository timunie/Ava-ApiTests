...
Defines the <a href="P_Avalonia_Layout_Layoutable_UseLayoutRounding">UseLayoutRounding</a> property.
...
```vb
Public Shared ReadOnly UseLayoutRoundingProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val UseLayoutRoundingProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
