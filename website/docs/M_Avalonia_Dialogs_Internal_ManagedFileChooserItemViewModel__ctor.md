...
```fsharp
new : unit -> ManagedFileChooserItemViewModel
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Dialogs/Internal/ManagedFileChooserItemViewModel.cs#L66" title="View the source code">View Source</a>
