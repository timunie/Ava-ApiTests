...
```fsharp
static member Tomato : Color with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/Colors.cs#L672" title="View the source code">View Source</a>
