...
```vb
Public Shared ReadOnly PinchEndedEvent As RoutedEvent(Of PinchEndedEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val PinchEndedEvent: RoutedEvent<PinchEndedEventArgs>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_Interactivity_RoutedEvent_1">RoutedEvent</a>(<a href="T_Avalonia_Input_PinchEndedEventArgs">PinchEndedEventArgs</a>)
