...
```fsharp
type ShutdownRequestedEventArgs = 
    class
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_ApplicationLifetimes_ShutdownRequestedEventArgs__ctor">ShutdownRequestedEventArgs()</a></td>
<td>Initializes a new instance of the ShutdownRequestedEventArgs class</td>
</tr>
</table>
