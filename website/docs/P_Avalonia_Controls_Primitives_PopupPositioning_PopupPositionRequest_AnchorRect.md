...
```vb
Public ReadOnly Property AnchorRect As Rect?
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member AnchorRect : Nullable<Rect> with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Primitives/PopupPositioning/PopupPositionRequest.cs#L33" title="View the source code">View Source</a>
