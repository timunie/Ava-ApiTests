...
```vb
Public Overridable ReadOnly Property DesktopScaling As Double
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract DesktopScaling : float with get
override DesktopScaling : float with get
```
</TabItem>
</Tabs>
...
#### Implements
<a href="P_Avalonia_Platform_ITopLevelImpl_DesktopScaling">ITopLevelImpl.DesktopScaling</a>  
