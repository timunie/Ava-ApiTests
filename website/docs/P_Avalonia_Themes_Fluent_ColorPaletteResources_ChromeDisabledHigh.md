...
```vb
Public Property ChromeDisabledHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeDisabledHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L102" title="View the source code">View Source</a>
