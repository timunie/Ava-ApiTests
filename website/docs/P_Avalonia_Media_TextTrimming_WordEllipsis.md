...
```vb
Public Shared ReadOnly Property WordEllipsis As TextTrimming
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static member WordEllipsis : TextTrimming with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextTrimming.cs#L26" title="View the source code">View Source</a>
