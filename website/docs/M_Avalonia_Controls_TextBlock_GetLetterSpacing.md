...
```csharp
public static double GetLetterSpacing(
	Control control
)
```
</TabItem>
...
```vb
Public Shared Function GetLetterSpacing ( 
	control As Control
) As Double
```
</TabItem>
...
```fsharp
static member GetLetterSpacing : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/TextBlock.cs#L528" title="View the source code">View Source</a>
