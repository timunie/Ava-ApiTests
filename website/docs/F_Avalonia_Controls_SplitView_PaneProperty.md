...
Defines the <a href="P_Avalonia_Controls_SplitView_Pane">Pane</a> property
...
```vb
Public Shared ReadOnly PaneProperty As StyledProperty(Of Object)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val PaneProperty: StyledProperty<Object>
```
</TabItem>
</Tabs>
