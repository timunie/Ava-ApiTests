...
```vb
Public Shared ReadOnly GridLinesVisibilityProperty As StyledProperty(Of DataGridGridLinesVisibility)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val GridLinesVisibilityProperty: StyledProperty<DataGridGridLinesVisibility>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_StyledProperty_1">StyledProperty</a>(<a href="T_Avalonia_Controls_DataGridGridLinesVisibility">DataGridGridLinesVisibility</a>)
