...
Defines the <a href="P_Avalonia_Controls_TextBox_UndoLimit">UndoLimit</a> property
...
```vb
Public Shared ReadOnly UndoLimitProperty As StyledProperty(Of Integer)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val UndoLimitProperty: StyledProperty<int>
```
</TabItem>
</Tabs>
