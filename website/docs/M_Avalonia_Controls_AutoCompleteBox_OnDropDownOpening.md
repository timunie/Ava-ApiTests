...
Raises the <a href="E_Avalonia_Controls_AutoCompleteBox_DropDownOpening">DropDownOpening</a> event.
...
```vb
Protected Overridable Sub OnDropDownOpening ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/AutoCompleteBox/AutoCompleteBox.cs#L965" title="View the source code">View Source</a>
