...
```vb
Public Shared Function GetHorizontalOffset ( 
	element As Control
) As Double
```
</TabItem>
...
```fsharp
static member GetHorizontalOffset : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/ToolTip.cs#L198" title="View the source code">View Source</a>
