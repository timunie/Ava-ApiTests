...
```vb
Public Property PageUp As List(Of KeyGesture)
	Get
	Set
```
</TabItem>
...
```fsharp
member PageUp : List<KeyGesture> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L129" title="View the source code">View Source</a>
