...
```vb
Public Property ListMedium As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ListMedium : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L152" title="View the source code">View Source</a>
