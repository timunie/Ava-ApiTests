...
```fsharp
member Bottom : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Converters/MarginMultiplierConverter.cs#L17" title="View the source code">View Source</a>
