...
<td>Initializes a new instance of the WindowBase class</td>
</tr>
<tr>
...
<td>Gets a value that indicates whether the window is active.</td>
</tr>
<tr>
...
<td>Gets or sets the owner of the window.</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Controls_WindowBase_PlatformImpl">PlatformImpl</a></td>
<td> </td>
</tr>
<tr>
...
<td>Gets platform screens implementation.</td>
</tr>
<tr>
...
<td>Gets or sets whether this window appears on top of all other windows</td>
</tr>
<tr>
...
<td>Overrides the core arrange logic for windows.<br />(Overrides <a href="M_Avalonia_Layout_Layoutable_ArrangeCore">Layoutable.ArrangeCore(Rect)</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_WindowBase_ArrangeSetBounds">ArrangeSetBounds(Size)</a></td>
<td>Called during the arrange pass to set the size of the window.</td>
</tr>
<tr>
...
<td>Ensures that the window is initialized.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_WindowBase_IsVisibleChanged">IsVisibleChanged(AvaloniaPropertyChangedEventArgs)</a></td>
<td> </td>
</tr>
<tr>
...
<td>Overrides the core measure logic for windows.<br />(Overrides <a href="M_Avalonia_Layout_Layoutable_MeasureCore">Layoutable.MeasureCore(Size)</a>)</td>
</tr>
<tr>
...
<td>Raises the <a href="E_Avalonia_Controls_TopLevel_Closed">Closed</a> event.<br />(Overrides <a href="M_Avalonia_Controls_TopLevel_OnClosed">TopLevel.OnClosed(EventArgs)</a>)</td>
</tr>
<tr>
...
<td>Raises the <a href="E_Avalonia_Controls_TopLevel_Opened">Opened</a> event.<br />(Overrides <a href="M_Avalonia_Controls_TopLevel_OnOpened">TopLevel.OnOpened(EventArgs)</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_WindowBase_OnPropertyChanged">OnPropertyChanged(AvaloniaPropertyChangedEventArgs)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Controls_TopLevel_OnPropertyChanged">TopLevel.OnPropertyChanged(AvaloniaPropertyChangedEventArgs)</a>)</td>
</tr>
<tr>
...
<td>Raises the <a href="E_Avalonia_Controls_WindowBase_Resized">Resized</a> event.</td>
</tr>
<tr>
...
<td>Fired when the window is activated.</td>
</tr>
<tr>
...
<td>Fired when the window is deactivated.</td>
</tr>
<tr>
...
<td>Fired when the window position is changed.</td>
</tr>
<tr>
...
<td>Occurs when the window is resized.</td>
</tr>
<tr>
