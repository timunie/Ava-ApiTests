...
<td>Overrides the core arrange logic for windows.<br />(Overrides Layoutable.ArrangeCore(Rect))</td>
</tr>
<tr>
...
<td>Overrides the core measure logic for windows.<br />(Overrides Layoutable.MeasureCore(Size))</td>
</tr>
<tr>
