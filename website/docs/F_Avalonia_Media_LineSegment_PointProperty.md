...
Defines the <a href="P_Avalonia_Media_LineSegment_Point">Point</a> property.
...
```vb
Public Shared ReadOnly PointProperty As StyledProperty(Of Point)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val PointProperty: StyledProperty<Point>
```
</TabItem>
</Tabs>
