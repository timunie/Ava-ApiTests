...
Initializes a new instance of the <a href="T_Avalonia_Dialogs_ManagedFileDialogOptions">ManagedFileDialogOptions</a> class
...
```fsharp
new : unit -> ManagedFileDialogOptions
```
</TabItem>
</Tabs>
