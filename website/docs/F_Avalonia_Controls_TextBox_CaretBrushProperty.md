...
Defines the <a href="P_Avalonia_Controls_TextBox_CaretBrush">CaretBrush</a> property
...
```vb
Public Shared ReadOnly CaretBrushProperty As StyledProperty(Of IBrush)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CaretBrushProperty: StyledProperty<IBrush>
```
</TabItem>
</Tabs>
