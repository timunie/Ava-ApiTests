...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/AvaloniaObjectExtensions.cs#L312" title="View the source code">View Source</a>
...
## Remarks
For styled properties, gets the value of the property excluding animated values, otherwise <a href="P_Avalonia_Data_Optional_1_Empty">Empty</a>. Note that this method does not return property values that come from inherited or default values. For direct properties returns the current value of the property.
