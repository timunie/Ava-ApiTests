...
```vb
Public Shared Function GetHorizontalScrollBarVisibility ( 
	control As Control
) As ScrollBarVisibility
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static member GetHorizontalScrollBarVisibility : 
        control : Control -> ScrollBarVisibility 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/ScrollViewer.cs#L470" title="View the source code">View Source</a>
