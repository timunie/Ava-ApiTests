...
Defines the <a href="P_Avalonia_Controls_Presenters_ContentPresenter_TextWrapping">TextWrapping</a> property
...
```vb
Public Shared ReadOnly TextWrappingProperty As StyledProperty(Of TextWrapping)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val TextWrappingProperty: StyledProperty<TextWrapping>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_StyledProperty_1">StyledProperty</a>(<a href="T_Avalonia_Media_TextWrapping">TextWrapping</a>)
