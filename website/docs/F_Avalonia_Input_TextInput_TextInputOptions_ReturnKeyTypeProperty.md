...
Defines the <a href="P_Avalonia_Input_TextInput_TextInputOptions_ReturnKeyType">ReturnKeyType</a> property.
...
```vb
Public Shared ReadOnly ReturnKeyTypeProperty As AttachedProperty(Of TextInputReturnKeyType)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ReturnKeyTypeProperty: AttachedProperty<TextInputReturnKeyType>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_AttachedProperty_1">AttachedProperty</a>(<a href="T_Avalonia_Input_TextInput_TextInputReturnKeyType">TextInputReturnKeyType</a>)
