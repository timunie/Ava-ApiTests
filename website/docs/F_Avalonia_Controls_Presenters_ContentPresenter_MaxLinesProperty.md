...
Defines the <a href="P_Avalonia_Controls_Presenters_ContentPresenter_MaxLines">MaxLines</a> property
...
```vb
Public Shared ReadOnly MaxLinesProperty As StyledProperty(Of Integer)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val MaxLinesProperty: StyledProperty<int>
```
</TabItem>
</Tabs>
