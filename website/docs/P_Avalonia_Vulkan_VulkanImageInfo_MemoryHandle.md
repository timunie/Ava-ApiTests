...
```vb
Public Property MemoryHandle As ULong
		Get
	Set
```
</TabItem>
...
```fsharp
member MemoryHandle : uint64 with 
		get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanImageInfo.cs#L13" title="View the source code">View Source</a>
