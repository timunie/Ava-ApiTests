...
Defines the <a href="P_Avalonia_Controls_ColorView_IsColorModelVisible">IsColorModelVisible</a> property.
...
```vb
Public Shared ReadOnly IsColorModelVisibleProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsColorModelVisibleProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
