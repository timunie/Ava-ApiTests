...
Initializes a new instance of the <a href="T_Avalonia_Rendering_Composition_Animations_CompositionAnimationGroup">CompositionAnimationGroup</a> class
...
```csharp
public CompositionAnimationGroup(
...
```fsharp
new : 
        compositor : Compositor -> CompositionAnimationGroup
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Rendering/Composition/Animations/CompositionAnimationGroup.cs#L9" title="View the source code">View Source</a>
