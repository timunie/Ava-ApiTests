# RelativePointTransition Class


Transition class that handles <a href="T_Avalonia_AvaloniaProperty">AvaloniaProperty</a> with <a href="T_Avalonia_RelativePoint">RelativePoint</a> type.
...
Public Class RelativePointTransition
	Inherits Transition(Of RelativePoint)
```
</TabItem>
...
<table>
<tr>
<td><a href="M_Avalonia_Animation_RelativePointTransition__ctor">RelativePointTransition()</a></td>
<td>Initializes a new instance of the RelativePointTransition class</td>
</tr>
</table>
