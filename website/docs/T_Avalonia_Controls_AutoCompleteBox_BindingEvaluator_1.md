...
```vb
Public Class BindingEvaluator(Of T)
	Inherits Control
```
</TabItem>
...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  AvaloniaObject  →  Animatable  →  StyledElement  →  Visual  →  Layoutable  →  Interactive  →  InputElement  →  <a href="T_Avalonia_Controls_Control">Control</a>  →  AutoCompleteBox.BindingEvaluator(T)</td></tr>
</table>



#### Type Parameters
<dl><dt /><dd>The type of dynamic binding to return.</dd></dl>
...
<tr>
<td><a href="P_Avalonia_Controls_AutoCompleteBox_BindingEvaluator_1_Value">Value</a></td>
<td>Gets or sets the data item value.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_AutoCompleteBox_BindingEvaluator_1_ValueBinding">ValueBinding</a></td>
<td>Gets or sets the value binding.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_AutoCompleteBox_BindingEvaluator_1_ClearDataContext">ClearDataContext</a></td>
<td>Clears the data context so that the control does not keep a reference to the last-looked up item.</td>
</tr>
<tr>
