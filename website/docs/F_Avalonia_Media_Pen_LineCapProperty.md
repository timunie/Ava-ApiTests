...
Defines the <a href="P_Avalonia_Media_Pen_LineCap">LineCap</a> property.
...
```vb
Public Shared ReadOnly LineCapProperty As StyledProperty(Of PenLineCap)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val LineCapProperty: StyledProperty<PenLineCap>
```
</TabItem>
</Tabs>
