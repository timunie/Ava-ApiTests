...
Defines the <a href="P_Avalonia_Controls_ColorView_IsColorPreviewVisible">IsColorPreviewVisible</a> property.
...
```vb
Public Shared ReadOnly IsColorPreviewVisibleProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsColorPreviewVisibleProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
