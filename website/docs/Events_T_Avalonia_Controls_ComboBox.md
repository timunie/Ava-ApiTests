...
<td>Occurs after the drop-down (popup) list of the <a href="T_Avalonia_Controls_ComboBox">ComboBox</a> closes.</td>
</tr>
<tr>
<td><a href="E_Avalonia_Controls_ComboBox_DropDownOpened">DropDownOpened</a></td>
<td>Occurs after the drop-down (popup) list of the <a href="T_Avalonia_Controls_ComboBox">ComboBox</a> opens.</td>
</tr>
<tr>
