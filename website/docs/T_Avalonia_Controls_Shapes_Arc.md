...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  AvaloniaObject  →  Animatable  →  StyledElement  →  Visual  →  Layoutable  →  Interactive  →  InputElement  →  <a href="T_Avalonia_Controls_Control">Control</a>  →  <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>  →  Arc</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Shapes_Arc__ctor">Arc</a></td>
<td>Initializes a new instance of the Arc class</td>
</tr>
</table>
...
<tr>
<td><a href="P_Avalonia_Controls_Shapes_Arc_StartAngle">StartAngle</a></td>
<td>Gets or sets the angle at which the arc starts, in degrees.</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Controls_Shapes_Arc_SweepAngle">SweepAngle</a></td>
<td>Gets or sets the angle, in degrees, added to the <a href="P_Avalonia_Controls_Shapes_Arc_StartAngle">StartAngle</a> defining where the arc ends. A positive value is clockwise, negative is counter-clockwise.</td>
</tr>
<tr>
<td>TabIndex</td>
<td><br />(Inherited from InputElement)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_Shapes_Arc_CreateDefiningGeometry">CreateDefiningGeometry</a></td>
