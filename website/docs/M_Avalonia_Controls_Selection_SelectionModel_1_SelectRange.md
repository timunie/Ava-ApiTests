...
```fsharp
abstract SelectRange : 
        start : int * 
        end : int -> unit 
override SelectRange : 
        start : int * 
        end : int -> unit 
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Selection/SelectionModel.cs#L248" title="View the source code">View Source</a>
...
#### Implements
<a href="M_Avalonia_Controls_Selection_ISelectionModel_SelectRange">ISelectionModel.SelectRange(Int32, Int32)</a>  
