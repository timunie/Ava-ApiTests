...
Raised when styles are added to <a href="T_Avalonia_Styling_Styles">Styles</a> or a nested styles collection.
...
```vb
Event GlobalStylesAdded As Action(Of IReadOnlyList(Of IStyle))
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract GlobalStylesAdded : IEvent<Action<IReadOnlyList<IStyle>>,
    EventArgs>
```
</TabItem>
</Tabs>
