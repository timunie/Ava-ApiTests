...
```csharp
public static int GetSizeOfSet(
...
```vb
Public Shared Function GetSizeOfSet ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Automation/AutomationProperties.cs#L493" title="View the source code">View Source</a>
