...
```vb
Public MustInherit Class PickerPresenterBase
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/DateTimePickers/PickerPresenterBase.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  AvaloniaObject  →  Animatable  →  StyledElement  →  Visual  →  Layoutable  →  Interactive  →  InputElement  →  <a href="T_Avalonia_Controls_Control">Control</a>  →  <a href="T_Avalonia_Controls_Primitives_TemplatedControl">TemplatedControl</a>  →  PickerPresenterBase</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="T_Avalonia_Controls_DatePickerPresenter">Avalonia.Controls.DatePickerPresenter</a><br /><a href="T_Avalonia_Controls_TimePickerPresenter">Avalonia.Controls.TimePickerPresenter</a></td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_PickerPresenterBase__ctor">PickerPresenterBase()</a></td>
<td>Initializes a new instance of the PickerPresenterBase class</td>
</tr>
</table>
