...
Defines the <a href="P_Avalonia_Controls_ColorView_IsAlphaEnabled">IsAlphaEnabled</a> property.
...
```vb
Public Shared ReadOnly IsAlphaEnabledProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsAlphaEnabledProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
