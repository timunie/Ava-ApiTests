...
```vb
Public Class SelectionModelSelectionChangedEventArgs(Of T)
	Inherits SelectionModelSelectionChangedEventArgs
```
</TabItem>
...
type SelectionModelSelectionChangedEventArgs<'T> = 
    class
        inherit SelectionModelSelectionChangedEventArgs
    end
```
</TabItem>
</Tabs>
...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.eventargs" target="_blank" rel="noopener noreferrer">EventArgs</a>  →  <a href="T_Avalonia_Controls_Selection_SelectionModelSelectionChangedEventArgs">SelectionModelSelectionChangedEventArgs</a>  →  SelectionModelSelectionChangedEventArgs(T)</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Selection_SelectionModelSelectionChangedEventArgs_1__ctor">SelectionModelSelectionChangedEventArgs(T)(IReadOnlyList(Int32), IReadOnlyList(Int32), IReadOnlyList(T), IReadOnlyList(T))</a></td>
<td>Initializes a new instance of the SelectionModelSelectionChangedEventArgs(T) class</td>
</tr>
</table>
...
<tr>
<td><a href="M_Avalonia_Controls_Selection_SelectionModelSelectionChangedEventArgs_1_GetUntypedDeselectedItems">GetUntypedDeselectedItems()</a></td>
<td><br />(Overrides <a href="M_Avalonia_Controls_Selection_SelectionModelSelectionChangedEventArgs_GetUntypedDeselectedItems">SelectionModelSelectionChangedEventArgs.GetUntypedDeselectedItems()</a>)</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_Selection_SelectionModelSelectionChangedEventArgs_1_GetUntypedSelectedItems">GetUntypedSelectedItems()</a></td>
<td><br />(Overrides <a href="M_Avalonia_Controls_Selection_SelectionModelSelectionChangedEventArgs_GetUntypedSelectedItems">SelectionModelSelectionChangedEventArgs.GetUntypedSelectedItems()</a>)</td>
</tr>
<tr>
