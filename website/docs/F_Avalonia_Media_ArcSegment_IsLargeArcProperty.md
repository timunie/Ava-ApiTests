...
Defines the <a href="P_Avalonia_Media_ArcSegment_IsLargeArc">IsLargeArc</a> property.
...
```vb
Public Shared ReadOnly IsLargeArcProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsLargeArcProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
