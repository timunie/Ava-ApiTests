...
```vb
Public Property UseDBusFilePicker As Boolean
	Get
	Set
```
</TabItem>
...
```fsharp
member UseDBusFilePicker : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.X11/X11Platform.cs#L296" title="View the source code">View Source</a>
