...
Enumerates an <a href="T_Avalonia_Visual">Visual</a> and its ancestors in the visual tree.
...
```csharp
public static IEnumerable<Visual> GetSelfAndVisualAncestors(
	this Visual visual
)
```
</TabItem>
...
```vb
<ExtensionAttribute>
Public Shared Function GetSelfAndVisualAncestors ( 
	visual As Visual
...
```fsharp
[<ExtensionAttribute>]
static member GetSelfAndVisualAncestors : 
