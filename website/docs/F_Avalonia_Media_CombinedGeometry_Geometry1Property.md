...
Defines the <a href="P_Avalonia_Media_CombinedGeometry_Geometry1">Geometry1</a> property.
...
```vb
Public Shared ReadOnly Geometry1Property As StyledProperty(Of Geometry)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val Geometry1Property: StyledProperty<Geometry>
```
</TabItem>
</Tabs>
