...
Enumerates the children of an <a href="T_Avalonia_Visual">Visual</a> in the visual tree.
...
```csharp
public static IEnumerable<Visual> GetVisualChildren(
	this Visual visual
)
```
</TabItem>
...
```vb
<ExtensionAttribute>
Public Shared Function GetVisualChildren ( 
	visual As Visual
...
```fsharp
[<ExtensionAttribute>]
static member GetVisualChildren : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/VisualTree/VisualExtensions.cs#L377" title="View the source code">View Source</a>
