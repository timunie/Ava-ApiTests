...
<td>Gets a default recycle key that can be used when an <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a> supports a single container type.</td>
</tr>
<tr>
...
<td>Gets the number of items being displayed by the <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a>.</td>
</tr>
<tr>
...
<td>Gets or sets a collection used to generate the content of the <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a>.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_ItemsControl_ItemsView">ItemsView</a></td>
<td>Gets a read-only view of the items in the <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a>.</td>
</tr>
<tr>
