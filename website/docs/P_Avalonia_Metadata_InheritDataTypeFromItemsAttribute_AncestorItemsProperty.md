...
```vb
Public ReadOnly Property AncestorItemsProperty As String
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member AncestorItemsProperty : string with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Metadata/InheritDataTypeFromItemsAttribute.cs#L27" title="View the source code">View Source</a>
