...
<td>Gets or sets a value that indicates whether the <a href="T_Avalonia_Controls_MenuItem">MenuItem</a> has a submenu.</td>
</tr>
<tr>
...
<td>Gets or sets a value indicating whether the <a href="T_Avalonia_Controls_MenuItem">MenuItem</a> is currently selected.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_MenuItem_IsSubMenuOpen">IsSubMenuOpen</a></td>
<td>Gets or sets a value that indicates whether the submenu of the <a href="T_Avalonia_Controls_MenuItem">MenuItem</a> is open.</td>
</tr>
<tr>
<td>IsTabStop</td>
<td><br />(Inherited from InputElement)</td>
...
<td>Gets a value that indicates whether the <a href="T_Avalonia_Controls_MenuItem">MenuItem</a> is a top-level main menu item.</td>
</tr>
<tr>
<td>IsVisible</td>
<td><br />(Inherited from Visual)</td>
...
<td>Gets or sets a value that indicates the submenu that this <a href="T_Avalonia_Controls_MenuItem">MenuItem</a> is within should not close when this item is clicked.</td>
</tr>
<tr>
<td>StyleKey</td>
<td><br />(Inherited from StyledElement)</td>
