...
Defines the <a href="P_Avalonia_Controls_Primitives_Popup_TakesFocusFromNativeControl">TakesFocusFromNativeControl</a> property.
...
```vb
Public Shared ReadOnly TakesFocusFromNativeControlProperty As AttachedProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val TakesFocusFromNativeControlProperty: AttachedProperty<bool>
```
</TabItem>
</Tabs>
