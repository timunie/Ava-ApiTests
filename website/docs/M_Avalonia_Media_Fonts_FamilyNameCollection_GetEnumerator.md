...
```vb
Public Function GetEnumerator As ImmutableReadOnlyListStructEnumerator(Of String)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member GetEnumerator : unit -> ImmutableReadOnlyListStructEnumerator<string> 
```
</TabItem>
</Tabs>
...
#### Return Value
<a href="T_Avalonia_Utilities_ImmutableReadOnlyListStructEnumerator_1">ImmutableReadOnlyListStructEnumerator</a>(<a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a>)
