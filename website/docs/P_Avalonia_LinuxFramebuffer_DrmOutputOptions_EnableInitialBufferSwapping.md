...
```vb
Public Property EnableInitialBufferSwapping As Boolean
	Get
	Set
```
</TabItem>
...
```fsharp
member EnableInitialBufferSwapping : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/DrmOutputOptions.cs#L20" title="View the source code">View Source</a>
