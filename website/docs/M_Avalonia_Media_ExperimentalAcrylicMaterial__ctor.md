...
Initializes a new instance of the <a href="T_Avalonia_Media_ExperimentalAcrylicMaterial">ExperimentalAcrylicMaterial</a> class
...
```fsharp
new : unit -> ExperimentalAcrylicMaterial
```
</TabItem>
</Tabs>
