# TextInputMethodClient Constructor


Initializes a new instance of the <a href="T_Avalonia_Input_TextInput_TextInputMethodClient">TextInputMethodClient</a> class
...
```fsharp
new : unit -> TextInputMethodClient
```
</TabItem>
</Tabs>
