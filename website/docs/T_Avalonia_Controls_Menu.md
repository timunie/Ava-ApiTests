...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Menu.cs" title="View the source code">View Source</a>
...
<td>Called when the control is added to a rooted visual tree.<br />(Overrides <a href="M_Avalonia_Controls_MenuBase_OnAttachedToVisualTree">MenuBase.OnAttachedToVisualTree(VisualTreeAttachmentEventArgs)</a>)</td>
</tr>
<tr>
