...
```vb
Public ReadOnly Property ShowFilters As Boolean
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member ShowFilters : bool with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Dialogs/Internal/ManagedFileChooserViewModel.cs#L60" title="View the source code">View Source</a>
