...
Initializes a new instance of the <a href="T_Avalonia_Controls_ContainerIndexChangedEventArgs">ContainerIndexChangedEventArgs</a> class
...
```csharp
public ContainerIndexChangedEventArgs(
	Control container,
	int oldIndex,
	int newIndex
)
...
new : 
        container : Control * 
        oldIndex : int * 
        newIndex : int -> ContainerIndexChangedEventArgs
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/ContainerIndexChangedEventArgs.cs#L10" title="View the source code">View Source</a>
