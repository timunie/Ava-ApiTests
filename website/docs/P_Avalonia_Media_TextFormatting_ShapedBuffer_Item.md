...
```fsharp
abstract Item : GlyphInfo with get, set
override Item : GlyphInfo with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/ShapedBuffer.cs#L85" title="View the source code">View Source</a>
...
#### Property Value
<a href="T_Avalonia_Media_TextFormatting_GlyphInfo">GlyphInfo</a>
