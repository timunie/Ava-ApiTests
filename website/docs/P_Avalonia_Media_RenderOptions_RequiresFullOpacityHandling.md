...
```vb
Public Property RequiresFullOpacityHandling As Boolean?
	Get
	Set
```
</TabItem>
...
```fsharp
member RequiresFullOpacityHandling : Nullable<bool> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/RenderOptions.cs#L11" title="View the source code">View Source</a>
