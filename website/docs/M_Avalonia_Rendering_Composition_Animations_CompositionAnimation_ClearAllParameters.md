...
```fsharp
member ClearAllParameters : unit -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Rendering/Composition/Animations/CompositionAnimation.cs#L32" title="View the source code">View Source</a>
