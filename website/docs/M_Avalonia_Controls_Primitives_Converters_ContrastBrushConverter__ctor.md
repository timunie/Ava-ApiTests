...
Initializes a new instance of the <a href="T_Avalonia_Controls_Primitives_Converters_ContrastBrushConverter">ContrastBrushConverter</a> class
...
```fsharp
new : unit -> ContrastBrushConverter
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.ColorPicker/Converters/ContrastBrushConverter.cs#L18" title="View the source code">View Source</a>
