...
Defines the <a href="P_Avalonia_Media_ExperimentalAcrylicMaterial_PlatformTransparencyCompensationLevel">PlatformTransparencyCompensationLevel</a> property.
...
```vb
Public Shared ReadOnly PlatformTransparencyCompensationLevelProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val PlatformTransparencyCompensationLevelProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
