...
```csharp
public static Vector3D Substract(
	Vector3D left,
	Vector3D right
)
```
...
```vb
Public Shared Function Substract ( 
	left As Vector3D,
	right As Vector3D
) As Vector3D
```
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Vector3D.cs#L60" title="View the source code">View Source</a>
