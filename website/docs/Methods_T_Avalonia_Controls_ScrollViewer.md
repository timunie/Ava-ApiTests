...
<td>Gets whether dragging of <a href="T_Avalonia_Controls_Primitives_Thumb">Thumb</a> elements should update the <a href="T_Avalonia_Controls_ScrollViewer">ScrollViewer</a> only when the user releases the mouse.</td>
</tr>
<tr>
...
<td>Sets whether dragging of <a href="T_Avalonia_Controls_Primitives_Thumb">Thumb</a> elements should update the <a href="T_Avalonia_Controls_ScrollViewer">ScrollViewer</a> only when the user releases the mouse.</td>
</tr>
<tr>
