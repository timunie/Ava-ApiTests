...
```vb
<ExtensionAttribute>
Public Shared Function Template ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Styling/Selectors.cs#L234" title="View the source code">View Source</a>
