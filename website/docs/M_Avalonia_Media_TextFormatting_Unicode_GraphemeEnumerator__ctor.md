...
Initializes a new instance of the <a href="T_Avalonia_Media_TextFormatting_Unicode_GraphemeEnumerator">GraphemeEnumerator</a> class
...
```fsharp
new : 
        text : ReadOnlySpan<char> -> GraphemeEnumerator
```
</TabItem>
</Tabs>
