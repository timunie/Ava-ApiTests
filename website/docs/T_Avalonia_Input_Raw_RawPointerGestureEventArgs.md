# RawPointerGestureEventArgs Class
...
```fsharp
type RawPointerGestureEventArgs = 
    class
...
<table>
<tr>
<td><a href="M_Avalonia_Input_Raw_RawPointerGestureEventArgs__ctor">RawPointerGestureEventArgs(IInputDevice, UInt64, IInputRoot, RawPointerEventType, Point, Vector, RawInputModifiers)</a></td>
<td>Initializes a new instance of the RawPointerGestureEventArgs class</td>
</tr>
</table>
...
<table>
<tr>
<td><a href="P_Avalonia_Input_Raw_RawPointerGestureEventArgs_Delta">Delta</a></td>
<td> </td>
</tr>
<tr>
