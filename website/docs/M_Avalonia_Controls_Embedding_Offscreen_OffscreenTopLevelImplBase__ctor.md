...
Initializes a new instance of the <a href="T_Avalonia_Controls_Embedding_Offscreen_OffscreenTopLevelImplBase">OffscreenTopLevelImplBase</a> class
...
```fsharp
new : unit -> OffscreenTopLevelImplBase
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/Embedding/Offscreen/OffscreenTopLevelImpl.cs#L14" title="View the source code">View Source</a>
