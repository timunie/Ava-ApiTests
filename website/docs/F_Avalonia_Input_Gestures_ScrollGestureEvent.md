...
```vb
Public Shared ReadOnly ScrollGestureEvent As RoutedEvent(Of ScrollGestureEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ScrollGestureEvent: RoutedEvent<ScrollGestureEventArgs>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_Interactivity_RoutedEvent_1">RoutedEvent</a>(<a href="T_Avalonia_Input_ScrollGestureEventArgs">ScrollGestureEventArgs</a>)
