...
Defines the <a href="P_Avalonia_Media_Pen_MiterLimit">MiterLimit</a> property.
...
```vb
Public Shared ReadOnly MiterLimitProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val MiterLimitProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
