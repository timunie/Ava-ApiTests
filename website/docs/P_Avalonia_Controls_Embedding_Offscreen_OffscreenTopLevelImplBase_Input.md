...
```vb
Public Property Input As Action(Of RawInputEventArgs)
	Get
	Set
```
</TabItem>
...
override Input : Action<RawInputEventArgs> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Embedding/Offscreen/OffscreenTopLevelImpl.cs#L58" title="View the source code">View Source</a>
...
#### Implements
<a href="P_Avalonia_Platform_ITopLevelImpl_Input">ITopLevelImpl.Input</a>  
