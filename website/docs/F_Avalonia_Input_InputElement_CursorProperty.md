...
```vb
Public Shared ReadOnly CursorProperty As StyledProperty(Of Cursor)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CursorProperty: StyledProperty<Cursor>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_StyledProperty_1">StyledProperty</a>(<a href="T_Avalonia_Input_Cursor">Cursor</a>)
