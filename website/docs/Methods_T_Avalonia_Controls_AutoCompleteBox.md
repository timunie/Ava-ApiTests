...
<td>Determines whether the text box or drop-down portion of the <a href="T_Avalonia_Controls_AutoCompleteBox">AutoCompleteBox</a> control has focus.</td>
</tr>
<tr>
...
<td>Builds the visual tree for the <a href="T_Avalonia_Controls_AutoCompleteBox">AutoCompleteBox</a> control when a new template is applied.<br />(Overrides <a href="M_Avalonia_Controls_Primitives_TemplatedControl_OnApplyTemplate">TemplatedControl.OnApplyTemplate(TemplateAppliedEventArgs)</a>)</td>
</tr>
<tr>
...
<td>Provides handling for the KeyDown event.<br />(Overrides <a href="M_Avalonia_Input_InputElement_OnKeyDown">InputElement.OnKeyDown(KeyEventArgs)</a>)</td>
</tr>
<tr>
...
<td>Notifies the <a href="T_Avalonia_Controls_AutoCompleteBox">AutoCompleteBox</a> that the Items property has been set and the data can be filtered to provide possible matches in the drop-down.</td>
</tr>
<tr>
