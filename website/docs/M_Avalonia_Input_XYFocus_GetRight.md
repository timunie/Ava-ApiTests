...
```csharp
public static InputElement GetRight(
	InputElement obj
)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Navigation/XYFocus.Properties.cs#L25" title="View the source code">View Source</a>
