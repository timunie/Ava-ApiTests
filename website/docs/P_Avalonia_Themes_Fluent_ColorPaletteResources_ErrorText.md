...
```vb
Public Property ErrorText As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ErrorText : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L142" title="View the source code">View Source</a>
