...
Defines the <a href="P_Avalonia_Controls_Window_ExtendClientAreaToDecorationsHint">ExtendClientAreaToDecorationsHint</a> property.
...
```vb
Public Shared ReadOnly ExtendClientAreaToDecorationsHintProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ExtendClientAreaToDecorationsHintProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
