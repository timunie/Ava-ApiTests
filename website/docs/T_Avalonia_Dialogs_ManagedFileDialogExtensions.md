# ManagedFileDialogExtensions Class
...
```vb
<ExtensionAttribute>
Public NotInheritable Class ManagedFileDialogExtensions
```
</TabItem>
...
[<SealedAttribute>]
[<ExtensionAttribute>]
type ManagedFileDialogExtensions = class end
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Dialogs/ManagedFileDialogExtensions.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  ManagedFileDialogExtensions</td></tr>
</table>
