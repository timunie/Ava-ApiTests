...
```fsharp
member ControlPoint1 : Point with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Animation/Easings/CubicBezierEasing.cs#L13" title="View the source code">View Source</a>
