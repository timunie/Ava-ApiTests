...
Defines the <a href="P_Avalonia_Controls_NativeMenuItem_ToolTip">ToolTip</a> property.
...
```vb
Public Shared ReadOnly ToolTipProperty As StyledProperty(Of String)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ToolTipProperty: StyledProperty<string>
```
</TabItem>
</Tabs>
