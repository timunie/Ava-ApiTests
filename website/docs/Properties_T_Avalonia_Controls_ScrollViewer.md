...
<td>Gets or sets a value that determines whether the <a href="T_Avalonia_Controls_ScrollViewer">ScrollViewer</a> uses a bring-into-view scroll behavior when an item in the view gets focus.</td>
</tr>
<tr>
...
<td>Gets or sets whether dragging of <a href="T_Avalonia_Controls_Primitives_Thumb">Thumb</a> elements should update the <a href="T_Avalonia_Controls_ScrollViewer">ScrollViewer</a> only when the user releases the mouse.</td>
</tr>
<tr>
