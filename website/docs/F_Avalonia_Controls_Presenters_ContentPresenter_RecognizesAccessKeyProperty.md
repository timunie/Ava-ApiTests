...
Defines the <a href="P_Avalonia_Controls_Presenters_ContentPresenter_RecognizesAccessKey">RecognizesAccessKey</a> property
...
```vb
Public Shared ReadOnly RecognizesAccessKeyProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val RecognizesAccessKeyProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
