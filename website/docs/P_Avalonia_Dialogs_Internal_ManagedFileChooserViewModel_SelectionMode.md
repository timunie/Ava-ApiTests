...
```vb
Public ReadOnly Property SelectionMode As SelectionMode
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member SelectionMode : SelectionMode with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Dialogs/Internal/ManagedFileChooserViewModel.cs#L61" title="View the source code">View Source</a>
