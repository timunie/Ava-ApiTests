# TryGetFeature&lt;T&gt;(IOptionalFeatureProvider, T) Method
...
```csharp
public static bool TryGetFeature<T>(
...
static member TryGetFeature : 
        provider : IOptionalFeatureProvider * 
        rv : 'T byref -> bool  when 'T : not struct
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Platform/IOptionalFeatureProvider.cs#L25" title="View the source code">View Source</a>



#### Parameters
<dl><dt>  <a href="T_Avalonia_Platform_IOptionalFeatureProvider">IOptionalFeatureProvider</a></dt><dd> </dd><dt>  T</dt><dd> </dd></dl>
