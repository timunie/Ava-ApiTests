...
```vb
Public Property MoveCursorToTheEndOfDocument As List(Of KeyGesture)
	Get
	Set
```
</TabItem>
...
```fsharp
member MoveCursorToTheEndOfDocument : List<KeyGesture> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L122" title="View the source code">View Source</a>
