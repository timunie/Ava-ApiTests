# RenderTargetCorruptedException(String) Constructor
...
```fsharp
new : 
        message : string -> RenderTargetCorruptedException
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/RenderTargetCorruptedException.cs#L12" title="View the source code">View Source</a>
