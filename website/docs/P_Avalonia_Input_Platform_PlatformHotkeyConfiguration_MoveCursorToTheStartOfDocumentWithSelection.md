...
```vb
Public Property MoveCursorToTheStartOfDocumentWithSelection As List(Of KeyGesture)
	Get
	Set
```
</TabItem>
...
```fsharp
member MoveCursorToTheStartOfDocumentWithSelection : List<KeyGesture> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L125" title="View the source code">View Source</a>
