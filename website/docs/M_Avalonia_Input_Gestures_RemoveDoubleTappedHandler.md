...
```vb
Public Shared Sub RemoveDoubleTappedHandler ( 
...
```fsharp
static member RemoveDoubleTappedHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L180" title="View the source code">View Source</a>
