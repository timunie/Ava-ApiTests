...
```vb
Protected Overridable Function CreateTextLayout ( 
	text As String
) As TextLayout
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/TextBlock.cs#L646" title="View the source code">View Source</a>
