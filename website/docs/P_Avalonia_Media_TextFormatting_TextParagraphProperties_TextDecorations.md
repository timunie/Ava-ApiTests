...
```vb
Public Overridable ReadOnly Property TextDecorations As TextDecorationCollection
	Get
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/TextParagraphProperties.cs#L52" title="View the source code">View Source</a>
