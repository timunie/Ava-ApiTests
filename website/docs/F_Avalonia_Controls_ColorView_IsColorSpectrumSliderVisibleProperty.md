...
Defines the <a href="P_Avalonia_Controls_ColorView_IsColorSpectrumSliderVisible">IsColorSpectrumSliderVisible</a> property.
...
```vb
Public Shared ReadOnly IsColorSpectrumSliderVisibleProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsColorSpectrumSliderVisibleProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
