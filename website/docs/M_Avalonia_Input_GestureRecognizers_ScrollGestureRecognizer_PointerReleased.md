...
```csharp
protected override void PointerReleased(
...
```vb
Protected Overrides Sub PointerReleased ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/GestureRecognizers/ScrollGestureRecognizer.cs#L169" title="View the source code">View Source</a>



#### Parameters
<dl><dt>  <a href="T_Avalonia_Input_PointerReleasedEventArgs">PointerReleasedEventArgs</a></dt><dd> </dd></dl>
