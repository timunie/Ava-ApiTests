...
Defines the <a href="P_Avalonia_Media_Brush_Opacity">Opacity</a> property.
...
```vb
Public Shared ReadOnly OpacityProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val OpacityProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
