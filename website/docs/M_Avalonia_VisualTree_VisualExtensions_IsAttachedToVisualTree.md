...
```csharp
public static bool IsAttachedToVisualTree(
	this Visual visual
)
```
</TabItem>
...
```vb
<ExtensionAttribute>
Public Shared Function IsAttachedToVisualTree ( 
	visual As Visual
) As Boolean
```
</TabItem>
...
```fsharp
[<ExtensionAttribute>]
static member IsAttachedToVisualTree : 
        visual : Visual -> bool 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/VisualTree/VisualExtensions.cs#L454" title="View the source code">View Source</a>
