...
```vb
Public Property BaseMedium As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member BaseMedium : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L62" title="View the source code">View Source</a>
