...
Defines the <a href="P_Avalonia_Controls_TextBox_NewLine">NewLine</a> property
...
```vb
Public Shared ReadOnly NewLineProperty As StyledProperty(Of String)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val NewLineProperty: StyledProperty<string>
```
</TabItem>
</Tabs>
