...
```vb
Public ReadOnly Property Fd As Integer
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member Fd : int with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/Output/DrmBindings.cs#L143" title="View the source code">View Source</a>
