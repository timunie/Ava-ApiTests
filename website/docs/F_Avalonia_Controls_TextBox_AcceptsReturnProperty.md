...
Defines the <a href="P_Avalonia_Controls_TextBox_AcceptsReturn">AcceptsReturn</a> property
...
```vb
Public Shared ReadOnly AcceptsReturnProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val AcceptsReturnProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
