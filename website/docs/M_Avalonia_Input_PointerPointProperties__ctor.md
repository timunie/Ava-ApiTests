...
```fsharp
new : unit -> PointerPointProperties
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/PointerPoint.cs#L116" title="View the source code">View Source</a>
