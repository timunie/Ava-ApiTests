...
<td>Renders the <a href="T_Avalonia_Controls_TextBlock">TextBlock</a> to a drawing context.<br />(Overrides <a href="M_Avalonia_Visual_Render">Visual.Render(DrawingContext)</a>)</td>
</tr>
<tr>
