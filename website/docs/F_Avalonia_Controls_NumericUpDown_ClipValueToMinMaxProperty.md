...
Defines the <a href="P_Avalonia_Controls_NumericUpDown_ClipValueToMinMax">ClipValueToMinMax</a> property.
...
```vb
Public Shared ReadOnly ClipValueToMinMaxProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ClipValueToMinMaxProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
