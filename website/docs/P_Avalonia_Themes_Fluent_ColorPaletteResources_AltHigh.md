...
```vb
Public Property AltHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member AltHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L27" title="View the source code">View Source</a>
