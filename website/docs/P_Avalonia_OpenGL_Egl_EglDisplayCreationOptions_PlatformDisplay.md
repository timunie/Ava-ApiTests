...
```vb
Public Property PlatformDisplay As IntPtr
	Get
	Set
```
</TabItem>
...
```fsharp
member PlatformDisplay : IntPtr with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.OpenGL/Egl/EglDisplayOptions.cs#L28" title="View the source code">View Source</a>
