...
```csharp
ValueTask<Object> TryGetRenderInterfaceFeature(
	Type featureType
)
```
</TabItem>
...
```vb
Function TryGetRenderInterfaceFeature ( 
	featureType As Type
...
```fsharp
abstract TryGetRenderInterfaceFeature : 
...
#### Return Value
<a href="https://learn.microsoft.com/dotnet/api/system.threading.tasks.valuetask-1" target="_blank" rel="noopener noreferrer">ValueTask</a>(<a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>)
