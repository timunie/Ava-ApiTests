...
```vb
Public Property ChromeHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L117" title="View the source code">View Source</a>
