...
```fsharp
abstract DeselectRange : 
        start : int * 
        end : int -> unit 
override DeselectRange : 
        start : int * 
        end : int -> unit 
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Selection/SelectionModel.cs#L252" title="View the source code">View Source</a>
...
#### Implements
<a href="M_Avalonia_Controls_Selection_ISelectionModel_DeselectRange">ISelectionModel.DeselectRange(Int32, Int32)</a>  
