...
```vb
Public Shared Function GetVerticalScrollBarVisibility ( 
	control As Control
...
```fsharp
static member GetVerticalScrollBarVisibility : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/ScrollViewer.cs#L570" title="View the source code">View Source</a>
