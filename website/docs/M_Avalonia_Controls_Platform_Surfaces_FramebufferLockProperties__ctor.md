...
# FramebufferLockProperties Constructor


Initializes a new instance of the <a href="T_Avalonia_Controls_Platform_Surfaces_FramebufferLockProperties">FramebufferLockProperties</a> class
...
```csharp
public FramebufferLockProperties(
	bool PreviousFrameIsRetained
)
```
</TabItem>
...
```vb
Public Sub New ( 
	PreviousFrameIsRetained As Boolean
)
```
</TabItem>
...
```fsharp
new : 
        PreviousFrameIsRetained : bool -> FramebufferLockProperties
```
</TabItem>
</Tabs>
