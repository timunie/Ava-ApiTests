...
```fsharp
member CanUserResizeColumns : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/DataGrid.cs#L187" title="View the source code">View Source</a>
