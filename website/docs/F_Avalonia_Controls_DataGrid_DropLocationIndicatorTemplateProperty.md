# DropLocationIndicatorTemplateProperty Field
...
```vb
Public Shared ReadOnly DropLocationIndicatorTemplateProperty As StyledProperty(Of ITemplate(Of Control))
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val DropLocationIndicatorTemplateProperty: StyledProperty<ITemplate<Control>>
```
</TabItem>
</Tabs>
