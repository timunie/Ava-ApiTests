...
Defines the <a href="P_Avalonia_Controls_Primitives_TemplatedControl_BorderBrush">BorderBrush</a> property.
...
```vb
Public Shared ReadOnly BorderBrushProperty As StyledProperty(Of IBrush)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val BorderBrushProperty: StyledProperty<IBrush>
```
</TabItem>
</Tabs>
