...
```vb
Public Property CaretBrush As IBrush
	Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Presenters/TextPresenter.cs#L309" title="View the source code">View Source</a>
