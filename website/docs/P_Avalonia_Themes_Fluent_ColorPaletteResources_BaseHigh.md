...
```vb
Public Property BaseHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member BaseHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L52" title="View the source code">View Source</a>
