...
```vb
Public Property ThemeVariant As ThemeVariant
	Get
	Set
```
</TabItem>
...
```fsharp
member ThemeVariant : ThemeVariant with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Diagnostics/Diagnostics/DevToolsOptions.cs#L49" title="View the source code">View Source</a>
