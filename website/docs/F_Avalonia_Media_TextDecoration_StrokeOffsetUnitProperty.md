...
Defines the <a href="P_Avalonia_Media_TextDecoration_StrokeOffsetUnit">StrokeOffsetUnit</a> property.
...
```vb
Public Shared ReadOnly StrokeOffsetUnitProperty As StyledProperty(Of TextDecorationUnit)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val StrokeOffsetUnitProperty: StyledProperty<TextDecorationUnit>
```
</TabItem>
</Tabs>
