...
```fsharp
member TextRun : TextRun with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/TextRunBounds.cs#L37" title="View the source code">View Source</a>
