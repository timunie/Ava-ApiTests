...
```vb
Public Property SampleCount As UInteger
		Get
	Set
```
</TabItem>
...
```fsharp
member SampleCount : uint32 with 
		get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanImageInfo.cs#L12" title="View the source code">View Source</a>
