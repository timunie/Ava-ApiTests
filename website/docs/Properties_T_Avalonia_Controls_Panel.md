...
<td>Gets the children of the <a href="T_Avalonia_Controls_Panel">Panel</a>.</td>
</tr>
<tr>
<td>Classes</td>
<td><br />(Inherited from StyledElement)</td>
...
<td>Gets whether the <a href="T_Avalonia_Controls_Panel">Panel</a> hosts the items created by an <a href="T_Avalonia_Controls_Presenters_ItemsPresenter">ItemsPresenter</a>.</td>
</tr>
<tr>
