...
```vb
Protected ReadOnly Property Target As IInputElement
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member Target : IInputElement with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/GestureRecognizers/GestureRecognizer.cs#L6" title="View the source code">View Source</a>
