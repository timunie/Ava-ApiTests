...
Represents an <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a> with a related header.
...
```csharp
[TemplatePartAttribute("PART_HeaderPresenter", typeof(ContentPresenter))]
public class HeaderedItemsControl : ItemsControl
```
</TabItem>
<TabItem value="vb" label="VB">
```vb
<TemplatePartAttribute("PART_HeaderPresenter", GetType(ContentPresenter))>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_HeaderedItemsControl__ctor">HeaderedItemsControl()</a></td>
<td>Initializes a new instance of the HeaderedItemsControl class</td>
</tr>
</table>
...
<td>Called when a container has been fully prepared to display an item.<br />(Inherited from <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_Primitives_HeaderedItemsControl_OnAttachedToLogicalTree">OnAttachedToLogicalTree(LogicalTreeAttachmentEventArgs)</a></td>
