...
```vb
<ExtensionAttribute>
Public Shared Function ToSKRect ( 
	r As Rect
) As SKRect
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Skia/Avalonia.Skia/SkiaSharpExtensions.cs#L75" title="View the source code">View Source</a>
