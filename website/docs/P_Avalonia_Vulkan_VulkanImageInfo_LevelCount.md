...
```vb
Public Property LevelCount As UInteger
		Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanImageInfo.cs#L11" title="View the source code">View Source</a>
