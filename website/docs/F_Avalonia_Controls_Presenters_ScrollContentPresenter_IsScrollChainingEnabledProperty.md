...
Defines the <a href="P_Avalonia_Controls_Presenters_ScrollContentPresenter_IsScrollChainingEnabled">IsScrollChainingEnabled</a> property.
...
```vb
Public Shared ReadOnly IsScrollChainingEnabledProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsScrollChainingEnabledProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
