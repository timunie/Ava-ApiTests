...
A <a href="T_Avalonia_Controls_ContentControl">ContentControl</a> with a header.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_HeaderedContentControl__ctor">HeaderedContentControl()</a></td>
<td>Initializes a new instance of the HeaderedContentControl class</td>
</tr>
</table>
...
<td>Gets or sets the header content.</td>
</tr>
<tr>
...
<td>Called when an <a href="T_Avalonia_Controls_Presenters_ContentPresenter">ContentPresenter</a> is registered with the control.<br />(Overrides <a href="M_Avalonia_Controls_ContentControl_RegisterContentPresenter">ContentControl.RegisterContentPresenter(ContentPresenter)</a>)</td>
</tr>
<tr>
