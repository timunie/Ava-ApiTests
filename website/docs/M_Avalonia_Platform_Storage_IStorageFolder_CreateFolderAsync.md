...
A new <a href="T_Avalonia_Platform_Storage_IStorageFolder">IStorageFolder</a> pointing to the moved file. If not null, the current storage item becomes invalid
