...
Defines custom placement parameters for a <a href="T_Avalonia_Controls_Primitives_PopupPositioning_CustomPopupPlacementCallback">CustomPopupPlacementCallback</a> callback.
...
```csharp
public class CustomPopupPlacement : IEquatable<CustomPopupPlacement>
```
</TabItem>
<TabItem value="vb" label="VB">
```vb
Public Class CustomPopupPlacement
	Implements IEquatable(Of CustomPopupPlacement)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
type CustomPopupPlacement = 
    class
        interface IEquatable<CustomPopupPlacement>
    end
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Primitives/PopupPositioning/CustomPopupPlacement.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  CustomPopupPlacement</td></tr>
<tr><td><strong>Implements</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.iequatable-1" target="_blank" rel="noopener noreferrer">IEquatable</a>(CustomPopupPlacement)</td></tr>
</table>
