...
#### Property Value
<a href="T_Avalonia_Media_Color">Color</a>Use this property instead of <a href="P_Avalonia_Controls_Primitives_ColorSlider_HsvColor">HsvColor</a> when in <a href="T_Avalonia_Controls_ColorModel">Rgba</a> to avoid loss of precision and color drifting.
