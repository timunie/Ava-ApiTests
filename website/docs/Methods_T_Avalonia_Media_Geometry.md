...
<td>Gets a <a href="T_Avalonia_Media_Geometry">Geometry</a> that is the shape defined by the stroke on the Geometry produced by the specified Pen.</td>
</tr>
<tr>
...
<td>Creates a <a href="T_Avalonia_Media_Geometry">Geometry</a> from a string.</td>
</tr>
<tr>
