...
```fsharp
member IconKey : string with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Dialogs/Internal/ManagedFileChooserItemViewModel.cs#L53" title="View the source code">View Source</a>
