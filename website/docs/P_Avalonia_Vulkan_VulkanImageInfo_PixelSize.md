...
```fsharp
member PixelSize : PixelSize with 
		get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanImageInfo.cs#L6" title="View the source code">View Source</a>
