...
```fsharp
member Ascent : int with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/FontMetrics.cs#L21" title="View the source code">View Source</a>
