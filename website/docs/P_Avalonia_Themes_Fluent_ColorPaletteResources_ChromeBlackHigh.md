...
```vb
Public Property ChromeBlackHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeBlackHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L82" title="View the source code">View Source</a>
