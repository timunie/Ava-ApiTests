...
```fsharp
member ControlPoint2 : Point with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Animation/Easings/CubicBezierEasing.cs#L12" title="View the source code">View Source</a>
