...
Defines the <a href="P_Avalonia_Controls_TextBox_MinLines">MinLines</a> property
...
```vb
Public Shared ReadOnly MinLinesProperty As StyledProperty(Of Integer)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val MinLinesProperty: StyledProperty<int>
```
</TabItem>
</Tabs>
