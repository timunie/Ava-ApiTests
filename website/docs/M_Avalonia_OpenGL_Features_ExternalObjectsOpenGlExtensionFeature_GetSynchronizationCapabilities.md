...
```vb
Public Function GetSynchronizationCapabilities ( 
...
override GetSynchronizationCapabilities : 
        imageHandleType : string -> CompositionGpuImportedImageSynchronizationCapabilities 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.OpenGL/Features/ExternalObjectsOpenGlExtensionFeature.cs#L207" title="View the source code">View Source</a>
...
#### Implements
<a href="M_Avalonia_OpenGL_IGlContextExternalObjectsFeature_GetSynchronizationCapabilities">IGlContextExternalObjectsFeature.GetSynchronizationCapabilities(String)</a>  
