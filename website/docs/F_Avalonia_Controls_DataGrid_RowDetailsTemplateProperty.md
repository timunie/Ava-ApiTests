...
```vb
Public Shared ReadOnly RowDetailsTemplateProperty As StyledProperty(Of IDataTemplate)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val RowDetailsTemplateProperty: StyledProperty<IDataTemplate>
```
</TabItem>
</Tabs>
