...
```vb
Public ReadOnly Property SubPixel As DrmModeSubPixel
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member SubPixel : DrmModeSubPixel with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/Output/DrmBindings.cs#L26" title="View the source code">View Source</a>



#### Property Value
<a href="T_Avalonia_LinuxFramebuffer_Output_DrmModeSubPixel">DrmModeSubPixel</a>
