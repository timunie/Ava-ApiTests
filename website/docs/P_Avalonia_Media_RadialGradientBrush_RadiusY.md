...
```vb
<DependsOnAttribute("Radius")>
Public Property RadiusY As RelativeScalar
	Get
	Set
```
</TabItem>
...
```fsharp
[<DependsOnAttribute("Radius")>]
abstract RadiusY : RelativeScalar with get, set
[<DependsOnAttribute("Radius")>]
override RadiusY : RelativeScalar with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/RadialGradientBrush.cs#L95" title="View the source code">View Source</a>
