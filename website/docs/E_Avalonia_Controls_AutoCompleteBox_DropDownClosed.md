...
Occurs when the <a href="P_Avalonia_Controls_AutoCompleteBox_IsDropDownOpen">IsDropDownOpen</a> property was changed from true to false and the drop-down is open.
