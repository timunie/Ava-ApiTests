...
Defines the <a href="P_Avalonia_Controls_Button_IsCancel">IsCancel</a> property.
...
```vb
Public Shared ReadOnly IsCancelProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsCancelProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
