...
<td>Default mouse wheel handler for the calendar control.<br />(Overrides <a href="M_Avalonia_Input_InputElement_OnPointerWheelChanged">InputElement.OnPointerWheelChanged(PointerWheelEventArgs)</a>)</td>
</tr>
<tr>
