...
Defines the <a href="P_Avalonia_Controls_MenuItem_IsSubMenuOpen">IsSubMenuOpen</a> property.
...
```vb
Public Shared ReadOnly IsSubMenuOpenProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsSubMenuOpenProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
