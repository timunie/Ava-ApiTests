...
Defines the <a href="P_Avalonia_Controls_ColorView_IsComponentSliderVisible">IsComponentSliderVisible</a> property.
...
```vb
Public Shared ReadOnly IsComponentSliderVisibleProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsComponentSliderVisibleProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
