...
Defines the <a href="P_Avalonia_Controls_Control_Tag">Tag</a> property.
...
```vb
Public Shared ReadOnly TagProperty As StyledProperty(Of Object)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val TagProperty: StyledProperty<Object>
```
</TabItem>
</Tabs>
