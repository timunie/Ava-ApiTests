...
member TryGetScalar : 
        propertyName : string * 
        value : float32 byref -> CompositionGetValueStatus 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Rendering/Composition/CompositionPropertySet.cs#L86" title="View the source code">View Source</a>
