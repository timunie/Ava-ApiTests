# RemovePointerTouchPadGestureSwipeHandler Method
...
```csharp
public static void RemovePointerTouchPadGestureSwipeHandler(
	Interactive element,
...
```vb
Public Shared Sub RemovePointerTouchPadGestureSwipeHandler ( 
...
```fsharp
static member RemovePointerTouchPadGestureSwipeHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L210" title="View the source code">View Source</a>
