...
```vb
Public Property ChromeBlackMediumLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeBlackMediumLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L97" title="View the source code">View Source</a>
