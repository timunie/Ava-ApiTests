...
```csharp
protected virtual void OnLoadingRowDetails(
...
```vb
Protected Overridable Sub OnLoadingRowDetails ( 
...
```fsharp
abstract OnLoadingRowDetails : 
        e : DataGridRowDetailsEventArgs -> unit 
override OnLoadingRowDetails : 
        e : DataGridRowDetailsEventArgs -> unit 
```
</TabItem>
</Tabs>
