...
Defines the <a href="P_Avalonia_Controls_Presenters_TextPresenter_LetterSpacing">LetterSpacing</a> property.
...
```vb
Public Shared ReadOnly LetterSpacingProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val LetterSpacingProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
