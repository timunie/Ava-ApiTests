...
```vb
Protected Overridable Sub IsVisibleChanged ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/WindowBase.cs#L351" title="View the source code">View Source</a>
