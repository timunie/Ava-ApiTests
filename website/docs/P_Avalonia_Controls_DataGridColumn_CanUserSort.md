...
```fsharp
member CanUserSort : bool with get, set
```
</TabItem>
</Tabs>
...
true if the user can sort the column; false if the user cannot sort the column. The default is the current <a href="P_Avalonia_Controls_DataGrid_CanUserSortColumns">CanUserSortColumns</a> property value.
