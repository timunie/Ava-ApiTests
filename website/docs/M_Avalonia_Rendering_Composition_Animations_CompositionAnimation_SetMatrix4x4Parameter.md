...
```csharp
public void SetMatrix4x4Parameter(
	string key,
	Matrix4x4 value
)
```
...
```vb
Public Sub SetMatrix4x4Parameter ( 
	key As String,
	value As Matrix4x4
)
```
...
```fsharp
member SetMatrix4x4Parameter : 
        key : string * 
        value : Matrix4x4 -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Rendering/Composition/Animations/CompositionAnimation.cs#L45" title="View the source code">View Source</a>
