...
```fsharp
static member One : Vector with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Vector.cs#L333" title="View the source code">View Source</a>
