...
Defines the <a href="P_Avalonia_Controls_Button_IsDefault">IsDefault</a> property.
...
```vb
Public Shared ReadOnly IsDefaultProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsDefaultProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
