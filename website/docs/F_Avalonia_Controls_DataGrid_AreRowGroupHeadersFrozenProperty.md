# AreRowGroupHeadersFrozenProperty Field
...
```vb
Public Shared ReadOnly AreRowGroupHeadersFrozenProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val AreRowGroupHeadersFrozenProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
