# RemovePointerTouchPadGestureMagnifyHandler Method
...
```csharp
public static void RemovePointerTouchPadGestureMagnifyHandler(
	Interactive element,
...
```vb
Public Shared Sub RemovePointerTouchPadGestureMagnifyHandler ( 
...
```fsharp
static member RemovePointerTouchPadGestureMagnifyHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L204" title="View the source code">View Source</a>
