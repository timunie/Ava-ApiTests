...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/Effects/Effect.cs#L23" title="View the source code">View Source</a>
...
#### Type Parameters
<dl><dt /><dd /></dl>After a call to this method in a brush's static constructor, any change to the property will cause the <a href="E_Avalonia_Media_Effect_Invalidated">Invalidated</a> event to be raised on the brush.
