...
```vb
Public Property VolumeSizeBytes As ULong
	Get
	Set
```
</TabItem>
...
```fsharp
member VolumeSizeBytes : uint64 with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Platform/Dialogs/MountedDriveInfo.cs#L14" title="View the source code">View Source</a>
