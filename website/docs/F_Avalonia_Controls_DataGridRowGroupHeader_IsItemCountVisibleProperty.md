# IsItemCountVisibleProperty Field
...
```vb
Public Shared ReadOnly IsItemCountVisibleProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsItemCountVisibleProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
