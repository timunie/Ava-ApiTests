...
Defines the <a href="P_Avalonia_Visual_ZIndex">ZIndex</a> property.
...
```vb
Public Shared ReadOnly ZIndexProperty As StyledProperty(Of Integer)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ZIndexProperty: StyledProperty<int>
```
</TabItem>
</Tabs>
