...
Defines the <a href="P_Avalonia_Input_TextInput_TextInputOptions_AutoCapitalization">AutoCapitalization</a> property.
...
```vb
Public Shared ReadOnly AutoCapitalizationProperty As AttachedProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val AutoCapitalizationProperty: AttachedProperty<bool>
```
</TabItem>
</Tabs>
