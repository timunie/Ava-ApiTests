...
```vb
Public Property Direction As PlaybackDirection
	Get
	Set
```
</TabItem>
...
```fsharp
member Direction : PlaybackDirection with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Rendering/Composition/Animations/KeyFrameAnimation.cs#L37" title="View the source code">View Source</a>



#### Property Value
<a href="T_Avalonia_Animation_PlaybackDirection">PlaybackDirection</a>
