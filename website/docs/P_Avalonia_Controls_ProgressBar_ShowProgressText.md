...
```fsharp
member ShowProgressText : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/ProgressBar.cs#L270" title="View the source code">View Source</a>
