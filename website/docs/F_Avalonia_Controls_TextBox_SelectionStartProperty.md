...
Defines the <a href="P_Avalonia_Controls_TextBox_SelectionStart">SelectionStart</a> property
...
```vb
Public Shared ReadOnly SelectionStartProperty As StyledProperty(Of Integer)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val SelectionStartProperty: StyledProperty<int>
```
</TabItem>
</Tabs>
