...
Occurs when the value of the <a href="P_Avalonia_Controls_AutoCompleteBox_IsDropDownOpen">IsDropDownOpen</a> property has changed from false to true and the drop-down is open.
