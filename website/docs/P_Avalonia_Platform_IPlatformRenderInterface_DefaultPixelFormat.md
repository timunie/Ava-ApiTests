# DefaultPixelFormat Property


Default <a href="T_Avalonia_Platform_PixelFormat">PixelFormat</a> used on this platform.
...
```vb
ReadOnly Property DefaultPixelFormat As PixelFormat
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract DefaultPixelFormat : PixelFormat with get
```
</TabItem>
</Tabs>
