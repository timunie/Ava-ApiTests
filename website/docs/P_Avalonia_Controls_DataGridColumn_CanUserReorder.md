...
true if the user can drag the column header to a new position; otherwise, false. The default is the current <a href="P_Avalonia_Controls_DataGrid_CanUserReorderColumns">CanUserReorderColumns</a> property value.
