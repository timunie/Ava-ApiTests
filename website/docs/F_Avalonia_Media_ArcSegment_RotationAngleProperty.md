...
Defines the <a href="P_Avalonia_Media_ArcSegment_RotationAngle">RotationAngle</a> property.
...
```vb
Public Shared ReadOnly RotationAngleProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val RotationAngleProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
