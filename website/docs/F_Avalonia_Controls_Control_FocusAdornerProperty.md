...
Defines the <a href="P_Avalonia_Controls_Control_FocusAdorner">FocusAdorner</a> property.
...
```vb
Public Shared ReadOnly FocusAdornerProperty As StyledProperty(Of ITemplate(Of Control))
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val FocusAdornerProperty: StyledProperty<ITemplate<Control>>
```
</TabItem>
</Tabs>
