...
Defines the <a href="P_Avalonia_Controls_GridSplitter_ShowsPreview">ShowsPreview</a> property.
...
```vb
Public Shared ReadOnly ShowsPreviewProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ShowsPreviewProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
