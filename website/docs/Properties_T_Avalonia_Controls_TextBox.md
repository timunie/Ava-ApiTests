...
<td>Gets or sets the maximum number of characters that the <a href="T_Avalonia_Controls_TextBox">TextBox</a> can accept. This constraint only applies for manually entered (user-inputted) text.</td>
</tr>
<tr>
