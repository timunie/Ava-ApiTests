# DataGridCellsPresenter Class


Used within the template of a <a href="T_Avalonia_Controls_DataGrid">DataGrid</a> to specify the location in the control's visual tree where the cells are to be added.
...
```vb
Public NotInheritable Class DataGridCellsPresenter
	Inherits Panel
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridCellsPresenter__ctor">DataGridCellsPresenter()</a></td>
<td>Initializes a new instance of the DataGridCellsPresenter class</td>
</tr>
</table>
