...
```vb
Public Property RequireComputeBit As Boolean
	Get
	Set
```
</TabItem>
...
```fsharp
member RequireComputeBit : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanOptions.cs#L62" title="View the source code">View Source</a>
