...
```csharp
public static bool GetAlignVerticalCenterWithPanel(
	AvaloniaObject obj
)
```
</TabItem>
...
```vb
Public Shared Function GetAlignVerticalCenterWithPanel ( 
...
```fsharp
static member GetAlignVerticalCenterWithPanel : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/RelativePanel.AttachedProperties.cs#L398" title="View the source code">View Source</a>
