...
```csharp
public virtual ListSortDirection Direction { get; }
```
</TabItem>
<TabItem value="vb" label="VB">
```vb
Public Overridable ReadOnly Property Direction As ListSortDirection
	Get
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/Collections/DataGridSortDescription.cs#L15" title="View the source code">View Source</a>
