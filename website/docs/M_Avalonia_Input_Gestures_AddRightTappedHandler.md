...
```csharp
public static void AddRightTappedHandler(
	Interactive element,
...
```vb
Public Shared Sub AddRightTappedHandler ( 
...
```fsharp
static member AddRightTappedHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L137" title="View the source code">View Source</a>
