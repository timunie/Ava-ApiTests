...
```vb
<AttributeUsageAttribute(AttributeTargets.All)>
Public NotInheritable Class UnstableAttribute
	Inherits Attribute
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Metadata/UnstableAttribute.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.attribute" target="_blank" rel="noopener noreferrer">Attribute</a>  →  UnstableAttribute</td></tr>
</table>
...
<td>Initializes a new instance of the UnstableAttribute class.</td>
</tr>
<tr>
...
<table>
<tr>
<td><a href="P_Avalonia_Metadata_UnstableAttribute_Message">Message</a></td>
<td>Gets a value that indicates whether the compiler will treat usage of the obsolete program element as an error.</td>
</tr>
<tr>
