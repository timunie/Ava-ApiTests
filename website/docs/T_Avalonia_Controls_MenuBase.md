...
```csharp
public abstract class MenuBase : SelectingItemsControl, 
	IFocusScope, IInputElement, ILogical
```
</TabItem>
...
Public MustInherit Class MenuBase
	...
	Implements IFocusScope, IInputElement, ILogical
```
</TabItem>
...
<td>Initializes a new instance of the MenuBase class.</td>
</tr>
<tr>
...
<td>Gets the interaction handler for the menu.</td>
</tr>
<tr>
...
<td>Gets a value indicating whether the menu is open.</td>
</tr>
<tr>
<td>IsPointerOver</td>
<td><br />(Inherited from InputElement)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_MenuBase_Close">Close()</a></td>
...
<td>Called when a submenu opens somewhere in the menu.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_MenuBase_Open">Open()</a></td>
...
<td>Occurs when a <a href="T_Avalonia_Controls_Menu">Menu</a> is closed.</td>
</tr>
<tr>
...
<td>Occurs when a <a href="T_Avalonia_Controls_Menu">Menu</a> is opened.</td>
</tr>
<tr>
