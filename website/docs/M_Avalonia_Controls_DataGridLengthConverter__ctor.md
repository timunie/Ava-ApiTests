# DataGridLengthConverter Constructor


Initializes a new instance of the <a href="T_Avalonia_Controls_DataGridLengthConverter">DataGridLengthConverter</a> class
...
```fsharp
new : unit -> DataGridLengthConverter
```
</TabItem>
</Tabs>
