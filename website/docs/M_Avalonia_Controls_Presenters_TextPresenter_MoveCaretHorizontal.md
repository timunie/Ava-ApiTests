...
```csharp
public void MoveCaretHorizontal(
...
```vb
Public Sub MoveCaretHorizontal ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Presenters/TextPresenter.cs#L861" title="View the source code">View Source</a>
