...
<td>Handles directional navigation within the <a href="T_Avalonia_Controls_ItemsControl">ItemsControl</a>.<br />(Overrides <a href="M_Avalonia_Input_InputElement_OnKeyDown">InputElement.OnKeyDown(KeyEventArgs)</a>)</td>
</tr>
<tr>
