...
Represents a tab in a <a href="T_Avalonia_Controls_Primitives_TabStrip">TabStrip</a>.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_TabStripItem__ctor">TabStripItem()</a></td>
<td>Initializes a new instance of the TabStripItem class</td>
</tr>
</table>
...
<td>Gets or sets the selection state of the item.<br />(Inherited from <a href="T_Avalonia_Controls_ListBoxItem">ListBoxItem</a>)</td>
</tr>
<tr>
<td>IsTabStop</td>
<td><br />(Inherited from InputElement)</td>
...
<td><br />(Inherited from <a href="T_Avalonia_Controls_ListBoxItem">ListBoxItem</a>)</td>
</tr>
<tr>
