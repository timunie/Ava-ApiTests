...
Defines the <a href="P_Avalonia_Controls_Shapes_Shape_StrokeDashOffset">StrokeDashOffset</a> property.
...
```vb
Public Shared ReadOnly StrokeDashOffsetProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val StrokeDashOffsetProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
