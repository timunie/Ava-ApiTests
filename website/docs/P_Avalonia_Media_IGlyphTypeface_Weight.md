...
Gets the designed weight of the font represented by the <a href="T_Avalonia_Media_IGlyphTypeface">IGlyphTypeface</a> object.
...
```vb
ReadOnly Property Weight As FontWeight
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract Weight : FontWeight with get
```
</TabItem>
</Tabs>
