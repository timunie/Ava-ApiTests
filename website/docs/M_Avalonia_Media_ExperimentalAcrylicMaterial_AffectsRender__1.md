...
## Remarks
After a call to this method in a brush's static constructor, any change to the property will cause the <a href="E_Avalonia_Media_ExperimentalAcrylicMaterial_Invalidated">Invalidated</a> event to be raised on the brush.
