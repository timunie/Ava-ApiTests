...
```vb
Public Shared Function GetRequiresFullOpacityHandling ( 
	visual As Visual
) As Boolean?
```
</TabItem>
...
```fsharp
static member GetRequiresFullOpacityHandling : 
        visual : Visual -> Nullable<bool> 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/RenderOptions.cs#L100" title="View the source code">View Source</a>
