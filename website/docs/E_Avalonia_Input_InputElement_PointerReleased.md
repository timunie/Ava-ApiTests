...
```vb
Public Event PointerReleased As EventHandler(Of PointerReleasedEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract PointerReleased : IEvent<EventHandler<PointerReleasedEventArgs>,
    PointerReleasedEventArgs>
override PointerReleased : IEvent<EventHandler<PointerReleasedEventArgs>,
    PointerReleasedEventArgs>
```
</TabItem>
</Tabs>
...
#### Implements
<a href="E_Avalonia_Input_IInputElement_PointerReleased">IInputElement.PointerReleased</a>  
