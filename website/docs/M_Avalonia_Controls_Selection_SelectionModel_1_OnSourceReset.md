...
```vb
Protected Overrides Sub OnSourceReset
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract OnSourceReset : unit -> unit 
override OnSourceReset : unit -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Selection/SelectionModel.cs#L343" title="View the source code">View Source</a>
