...
Defines the <a href="P_Avalonia_Input_TextInput_TextInputOptions_ContentType">ContentType</a> property.
...
```vb
Public Shared ReadOnly ContentTypeProperty As AttachedProperty(Of TextInputContentType)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ContentTypeProperty: AttachedProperty<TextInputContentType>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_AttachedProperty_1">AttachedProperty</a>(<a href="T_Avalonia_Input_TextInput_TextInputContentType">TextInputContentType</a>)
