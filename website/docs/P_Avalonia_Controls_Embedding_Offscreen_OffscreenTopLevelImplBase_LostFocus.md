...
```vb
Public Property LostFocus As Action
	Get
	Set
```
</TabItem>
...
override LostFocus : Action with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/Embedding/Offscreen/OffscreenTopLevelImpl.cs#L80" title="View the source code">View Source</a>
...
#### Implements
<a href="P_Avalonia_Platform_ITopLevelImpl_LostFocus">ITopLevelImpl.LostFocus</a>  
