...
```vb
Public ReadOnly Property Handle As IPlatformHandle
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
abstract Handle : IPlatformHandle with get
override Handle : IPlatformHandle with get
```
</TabItem>
</Tabs>
...
#### Implements
<a href="P_Avalonia_Platform_ITopLevelImpl_Handle">ITopLevelImpl.Handle</a>  
