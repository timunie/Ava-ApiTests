...
Defines the <a href="P_Avalonia_Media_Rotate3DTransform_CenterZ">CenterZ</a> property.
...
```vb
Public Shared ReadOnly CenterZProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CenterZProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
