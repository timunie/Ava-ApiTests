...
Defines the <a href="P_Avalonia_Controls_AutoCompleteBox_InnerRightContent">InnerRightContent</a> property
...
```vb
Public Shared ReadOnly InnerRightContentProperty As StyledProperty(Of Object)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val InnerRightContentProperty: StyledProperty<Object>
```
</TabItem>
</Tabs>
