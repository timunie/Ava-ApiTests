...
Defines the <a href="P_Avalonia_Animation_TransitionBase_Delay">Delay</a> property.
...
```vb
Public Shared ReadOnly DelayProperty As DirectProperty(Of TransitionBase, TimeSpan)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val DelayProperty: DirectProperty<TransitionBase, TimeSpan>
```
</TabItem>
</Tabs>
