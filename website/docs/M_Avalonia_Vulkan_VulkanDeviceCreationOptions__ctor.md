...
Initializes a new instance of the <a href="T_Avalonia_Vulkan_VulkanDeviceCreationOptions">VulkanDeviceCreationOptions</a> class
...
```fsharp
new : unit -> VulkanDeviceCreationOptions
```
</TabItem>
</Tabs>
