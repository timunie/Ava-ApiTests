...
```vb
Public Shared ReadOnly MenuProperty As AttachedProperty(Of NativeMenu)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val MenuProperty: AttachedProperty<NativeMenu>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_AttachedProperty_1">AttachedProperty</a>(<a href="T_Avalonia_Controls_NativeMenu">NativeMenu</a>)
