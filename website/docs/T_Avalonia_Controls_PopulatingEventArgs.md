...
Provides data for the <a href="E_Avalonia_Controls_AutoCompleteBox_Populating">Populating</a> event.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_PopulatingEventArgs__ctor">PopulatingEventArgs(String)</a></td>
<td>Initializes a new instance of the PopulatingEventArgs.</td>
</tr>
</table>
