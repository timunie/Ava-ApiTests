...
Defines the <a href="P_Avalonia_Controls_ProgressBar_ProgressBarTemplateSettings_ContainerAnimationStartPosition">ContainerAnimationStartPosition</a> property.
...
```vb
Public Shared ReadOnly ContainerAnimationStartPositionProperty As DirectProperty(Of ProgressBar.ProgressBarTemplateSettings, Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ContainerAnimationStartPositionProperty: DirectProperty<ProgressBar.ProgressBarTemplateSettings, float>
```
</TabItem>
</Tabs>
