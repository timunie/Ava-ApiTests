...
```vb
Public MustInherit Class InterpolatingTransitionBase(Of T)
	Inherits Transition(Of T)
```
</TabItem>
...
<table>
<tr>
<td><a href="M_Avalonia_Animation_InterpolatingTransitionBase_1__ctor">InterpolatingTransitionBase(T)()</a></td>
<td>Initializes a new instance of the InterpolatingTransitionBase(T) class</td>
</tr>
</table>
...
<tr>
<td><a href="M_Avalonia_Animation_InterpolatingTransitionBase_1_Interpolate">Interpolate(Double, T, T)</a></td>
<td> </td>
</tr>
<tr>
