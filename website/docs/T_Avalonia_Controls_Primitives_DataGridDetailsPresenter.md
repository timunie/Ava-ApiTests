...
Used within the template of a <a href="T_Avalonia_Controls_DataGrid">DataGrid</a> to specify the location in the control's visual tree where the row details are to be added.
...
```vb
Public NotInheritable Class DataGridDetailsPresenter
	Inherits Panel
```
</TabItem>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridDetailsPresenter__ctor">DataGridDetailsPresenter()</a></td>
<td>Initializes a new instance of the DataGridDetailsPresenter class</td>
</tr>
</table>
...
<tr>
<td><a href="P_Avalonia_Controls_Primitives_DataGridDetailsPresenter_ContentHeight">ContentHeight</a></td>
<td>Gets or sets the height of the content.</td>
</tr>
<tr>
