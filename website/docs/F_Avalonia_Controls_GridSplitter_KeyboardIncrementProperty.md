...
Defines the <a href="P_Avalonia_Controls_GridSplitter_KeyboardIncrement">KeyboardIncrement</a> property.
...
```vb
Public Shared ReadOnly KeyboardIncrementProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val KeyboardIncrementProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
