...
A button with primary and secondary parts that can each be pressed separately. The primary part behaves like a <a href="T_Avalonia_Controls_Button">Button</a> and the secondary part opens a flyout.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_SplitButton__ctor">SplitButton()</a></td>
<td>Initializes a new instance of the SplitButton class.</td>
</tr>
</table>
...
<td>Gets or sets the <a href="https://learn.microsoft.com/dotnet/api/system.windows.input.icommand" target="_blank" rel="noopener noreferrer">ICommand</a> invoked when the primary part is pressed.</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_SplitButton_CommandParameter">CommandParameter</a></td>
<td>Gets or sets a parameter to be passed to the <a href="P_Avalonia_Controls_SplitButton_Command">Command</a>.</td>
</tr>
<tr>
...
<td>Gets or sets the <a href="T_Avalonia_Controls_Primitives_FlyoutBase">FlyoutBase</a> that is shown when the secondary part is pressed.</td>
</tr>
<tr>
<td>Focusable</td>
<td><br />(Inherited from InputElement)</td>
...
<td>Gets or sets an KeyGesture associated with this control</td>
</tr>
<tr>
...
<td><br />(Overrides InputElement.IsEnabledCore)</td>
</tr>
<tr>
<td>IsFocused</td>
<td><br />(Inherited from InputElement)</td>
...
<td>Closes the secondary button's flyout.</td>
</tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Controls_Primitives_TemplatedControl_OnAttachedToLogicalTree">TemplatedControl.OnAttachedToLogicalTree(LogicalTreeAttachmentEventArgs)</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_SplitButton_OnClickPrimary">OnClickPrimary(RoutedEventArgs)</a></td>
<td>Invokes the <a href="E_Avalonia_Controls_SplitButton_Click">Click</a> event when the primary button part is clicked.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_SplitButton_OnClickSecondary">OnClickSecondary(RoutedEventArgs)</a></td>
<td>Invoked when the secondary button part is clicked.</td>
</tr>
<tr>
...
<td>Invoked when the split button's flyout is closed.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_SplitButton_OnFlyoutOpened">OnFlyoutOpened()</a></td>
<td>Invoked when the split button's flyout is opened.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_SplitButton_OnPropertyChanged">OnPropertyChanged(AvaloniaPropertyChangedEventArgs)</a></td>
...
<td>Opens the secondary button's flyout.</td>
</tr>
<tr>
...
<td>Raised when the user presses the primary part of the SplitButton.</td>
</tr>
<tr>
