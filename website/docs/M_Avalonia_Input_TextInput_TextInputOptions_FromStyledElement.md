...
```csharp
public static TextInputOptions FromStyledElement(
...
```vb
Public Shared Function FromStyledElement ( 
...
```fsharp
static member FromStyledElement : 
        avaloniaObject : StyledElement -> TextInputOptions 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/TextInput/TextInputOptions.cs#L7" title="View the source code">View Source</a>
