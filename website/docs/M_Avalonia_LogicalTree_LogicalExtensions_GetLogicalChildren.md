...
Enumerates the children of an <a href="T_Avalonia_LogicalTree_ILogical">ILogical</a> in the logical tree.
...
```csharp
public static IEnumerable<ILogical> GetLogicalChildren(
...
```vb
<ExtensionAttribute>
Public Shared Function GetLogicalChildren ( 
	logical As ILogical
...
```fsharp
[<ExtensionAttribute>]
static member GetLogicalChildren : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/LogicalTree/LogicalExtensions.cs#L80" title="View the source code">View Source</a>
