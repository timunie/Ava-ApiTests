...
```fsharp
abstract CommitEdit : unit -> unit 
override CommitEdit : unit -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/Collections/DataGridCollectionView.cs#L1463" title="View the source code">View Source</a>
