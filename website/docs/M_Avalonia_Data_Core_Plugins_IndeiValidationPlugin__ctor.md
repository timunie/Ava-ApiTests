# IndeiValidationPlugin Constructor


Initializes a new instance of the <a href="T_Avalonia_Data_Core_Plugins_IndeiValidationPlugin">IndeiValidationPlugin</a> class
...
```fsharp
new : unit -> IndeiValidationPlugin
```
</TabItem>
</Tabs>
