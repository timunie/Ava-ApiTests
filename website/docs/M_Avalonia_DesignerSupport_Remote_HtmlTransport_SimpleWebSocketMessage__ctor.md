...
Initializes a new instance of the <a href="T_Avalonia_DesignerSupport_Remote_HtmlTransport_SimpleWebSocketMessage">SimpleWebSocketMessage</a> class
...
```fsharp
new : unit -> SimpleWebSocketMessage
```
</TabItem>
</Tabs>
