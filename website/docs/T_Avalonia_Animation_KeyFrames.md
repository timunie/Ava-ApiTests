...
A collection of <a href="T_Avalonia_Animation_KeyFrame">KeyFrame</a>s.
...
```vb
Public NotInheritable Class KeyFrames
	Inherits AvaloniaList(Of KeyFrame)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Animation/KeyFrames.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList</a>(<a href="T_Avalonia_Animation_KeyFrame">KeyFrame</a>)  →  KeyFrames</td></tr>
</table>
...
<td>Initializes a new instance of the KeyFrames class.</td>
</tr>
<tr>
