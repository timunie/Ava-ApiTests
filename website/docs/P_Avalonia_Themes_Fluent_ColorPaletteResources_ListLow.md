...
```vb
Public Property ListLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ListLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L147" title="View the source code">View Source</a>
