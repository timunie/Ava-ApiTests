...
```vb
Public Event HeaderPointerReleased As EventHandler(Of PointerReleasedEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member HeaderPointerReleased : IEvent<EventHandler<PointerReleasedEventArgs>,
