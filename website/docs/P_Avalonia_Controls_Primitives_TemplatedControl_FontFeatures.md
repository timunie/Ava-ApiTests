...
```vb
Public Property FontFeatures As FontFeatureCollection
	Get
	Set
```
</TabItem>
...
```fsharp
member FontFeatures : FontFeatureCollection with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Primitives/TemplatedControl.cs#L196" title="View the source code">View Source</a>
