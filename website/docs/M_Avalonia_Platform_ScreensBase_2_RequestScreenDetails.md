...
```fsharp
abstract RequestScreenDetails : unit -> Task<bool> 
override RequestScreenDetails : unit -> Task<bool> 
```
</TabItem>
</Tabs>
...
#### Implements
<a href="M_Avalonia_Platform_IScreenImpl_RequestScreenDetails">IScreenImpl.RequestScreenDetails()</a>  
