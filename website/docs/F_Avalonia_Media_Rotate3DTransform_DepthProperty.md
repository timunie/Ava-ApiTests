...
Defines the <a href="P_Avalonia_Media_Rotate3DTransform_Depth">Depth</a> property.
...
```vb
Public Shared ReadOnly DepthProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val DepthProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
