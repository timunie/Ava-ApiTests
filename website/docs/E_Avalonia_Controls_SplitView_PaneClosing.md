...
#### Value
<a href="https://learn.microsoft.com/dotnet/api/system.eventhandler-1" target="_blank" rel="noopener noreferrer">EventHandler</a>(CancelRoutedEventArgs)The event args Cancel property may be set to true to cancel the event and keep the pane open.
