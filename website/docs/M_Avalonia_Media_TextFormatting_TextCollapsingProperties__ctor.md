# TextCollapsingProperties Constructor


Initializes a new instance of the <a href="T_Avalonia_Media_TextFormatting_TextCollapsingProperties">TextCollapsingProperties</a> class
...
```fsharp
new : unit -> TextCollapsingProperties
```
</TabItem>
</Tabs>
