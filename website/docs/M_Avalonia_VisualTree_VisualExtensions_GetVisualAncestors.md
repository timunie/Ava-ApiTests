...
Enumerates the ancestors of an <a href="T_Avalonia_Visual">Visual</a> in the visual tree.
...
```csharp
public static IEnumerable<Visual> GetVisualAncestors(
	this Visual visual
)
```
</TabItem>
...
```vb
<ExtensionAttribute>
Public Shared Function GetVisualAncestors ( 
	visual As Visual
...
```fsharp
[<ExtensionAttribute>]
static member GetVisualAncestors : 
