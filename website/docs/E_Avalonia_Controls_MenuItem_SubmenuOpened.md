...
Occurs when a <a href="T_Avalonia_Controls_MenuItem">MenuItem</a>'s submenu is opened.
...
```vb
Public Event SubmenuOpened As EventHandler(Of RoutedEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member SubmenuOpened : IEvent<EventHandler<RoutedEventArgs>,
    RoutedEventArgs>
```
</TabItem>
</Tabs>
