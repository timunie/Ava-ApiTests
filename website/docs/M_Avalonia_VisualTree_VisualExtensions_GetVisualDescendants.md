...
Enumerates the descendants of an <a href="T_Avalonia_Visual">Visual</a> in the visual tree.
...
```csharp
public static IEnumerable<Visual> GetVisualDescendants(
	this Visual visual
)
```
</TabItem>
...
```vb
<ExtensionAttribute>
Public Shared Function GetVisualDescendants ( 
	visual As Visual
...
```fsharp
[<ExtensionAttribute>]
static member GetVisualDescendants : 
