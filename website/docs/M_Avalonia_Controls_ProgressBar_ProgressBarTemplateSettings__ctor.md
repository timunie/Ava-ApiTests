...
Initializes a new instance of the <a href="T_Avalonia_Controls_ProgressBar_ProgressBarTemplateSettings">ProgressBar.ProgressBarTemplateSettings</a> class
...
```fsharp
new : unit -> ProgressBarTemplateSettings
```
</TabItem>
</Tabs>
