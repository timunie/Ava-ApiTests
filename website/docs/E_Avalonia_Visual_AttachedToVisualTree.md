...
```vb
Public Event AttachedToVisualTree As EventHandler(Of VisualTreeAttachmentEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member AttachedToVisualTree : IEvent<EventHandler<VisualTreeAttachmentEventArgs>,
