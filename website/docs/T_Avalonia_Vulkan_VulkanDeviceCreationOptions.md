...
```fsharp
type VulkanDeviceCreationOptions = class end
```
</TabItem>
</Tabs>
...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  VulkanDeviceCreationOptions</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Vulkan_VulkanDeviceCreationOptions__ctor">VulkanDeviceCreationOptions()</a></td>
<td>Initializes a new instance of the VulkanDeviceCreationOptions class</td>
</tr>
</table>
