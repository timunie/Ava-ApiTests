...
<td>Gets or sets the direction in which the <a href="T_Avalonia_Controls_Expander">Expander</a> opens.</td>
</tr>
<tr>
<td>FlowDirection</td>
<td><br />(Inherited from Visual)</td>
...
<td>Gets or sets a value indicating whether the <a href="T_Avalonia_Controls_Expander">Expander</a> content area is open and visible.</td>
</tr>
<tr>
<td>IsFocused</td>
<td><br />(Inherited from InputElement)</td>
