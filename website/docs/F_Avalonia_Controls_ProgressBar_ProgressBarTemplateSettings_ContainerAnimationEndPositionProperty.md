...
Defines the <a href="P_Avalonia_Controls_ProgressBar_ProgressBarTemplateSettings_ContainerAnimationEndPosition">ContainerAnimationEndPosition</a> property.
...
```vb
Public Shared ReadOnly ContainerAnimationEndPositionProperty As DirectProperty(Of ProgressBar.ProgressBarTemplateSettings, Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ContainerAnimationEndPositionProperty: DirectProperty<ProgressBar.ProgressBarTemplateSettings, float>
```
</TabItem>
</Tabs>
