...
Gets the absolute value of the <a href="T_Avalonia_Controls_DataGridLength">DataGridLength</a> in pixels.
...
The absolute value of the <a href="T_Avalonia_Controls_DataGridLength">DataGridLength</a> in pixels.
