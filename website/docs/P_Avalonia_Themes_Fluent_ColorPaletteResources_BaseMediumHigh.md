...
```vb
Public Property BaseMediumHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member BaseMediumHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L67" title="View the source code">View Source</a>
