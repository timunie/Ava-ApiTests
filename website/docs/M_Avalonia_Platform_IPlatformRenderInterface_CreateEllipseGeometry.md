...
```csharp
IGeometryImpl CreateEllipseGeometry(
	Rect rect
)
```
</TabItem>
...
```fsharp
abstract CreateEllipseGeometry : 
...
#### Parameters
<dl><dt>  <a href="T_Avalonia_Rect">Rect</a></dt><dd>The bounds of the ellipse.</dd></dl>
