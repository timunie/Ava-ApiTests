...
```vb
Public Property ColumnHeaderTheme As ControlTheme
	Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/DataGrid.cs#L277" title="View the source code">View Source</a>
