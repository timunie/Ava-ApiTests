...
Defines the <a href="P_Avalonia_Controls_Primitives_Popup_VerticalOffset">VerticalOffset</a> property.
...
```vb
Public Shared ReadOnly VerticalOffsetProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val VerticalOffsetProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
