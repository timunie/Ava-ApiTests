...
```vb
Public Shared Function GetErrors ( 
	control As Control
...
```fsharp
static member GetErrors : 
        control : Control -> IEnumerable<Object> 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/DataValidationErrors.cs#L118" title="View the source code">View Source</a>
