...
```vb
Public Shared ReadOnly CustomPopupPlacementCallbackProperty As AttachedProperty(Of CustomPopupPlacementCallback)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CustomPopupPlacementCallbackProperty: AttachedProperty<CustomPopupPlacementCallback>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_AttachedProperty_1">AttachedProperty</a>(<a href="T_Avalonia_Controls_Primitives_PopupPositioning_CustomPopupPlacementCallback">CustomPopupPlacementCallback</a>)
