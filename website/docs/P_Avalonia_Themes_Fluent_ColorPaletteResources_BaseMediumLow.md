...
```vb
Public Property BaseMediumLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member BaseMediumLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L72" title="View the source code">View Source</a>
