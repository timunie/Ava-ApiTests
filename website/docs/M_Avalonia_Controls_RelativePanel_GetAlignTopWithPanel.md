...
```csharp
public static bool GetAlignTopWithPanel(
	AvaloniaObject obj
)
```
</TabItem>
...
```vb
Public Shared Function GetAlignTopWithPanel ( 
...
```fsharp
static member GetAlignTopWithPanel : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/RelativePanel.AttachedProperties.cs#L337" title="View the source code">View Source</a>
