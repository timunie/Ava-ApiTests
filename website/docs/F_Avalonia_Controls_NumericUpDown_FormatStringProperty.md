...
Defines the <a href="P_Avalonia_Controls_NumericUpDown_FormatString">FormatString</a> property.
...
```vb
Public Shared ReadOnly FormatStringProperty As StyledProperty(Of String)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val FormatStringProperty: StyledProperty<string>
```
</TabItem>
</Tabs>
