...
```vb
Public Function CreateGlRenderTarget As IGlPlatformSurfaceRenderTarget
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member CreateGlRenderTarget : unit -> IGlPlatformSurfaceRenderTarget 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/Output/DrmOutput.cs#L247" title="View the source code">View Source</a>
