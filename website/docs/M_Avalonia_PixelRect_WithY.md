...
Returns a new <a href="T_Avalonia_PixelRect">PixelRect</a> with the specified Y position.
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.int32" target="_blank" rel="noopener noreferrer">Int32</a></dt><dd>The y position.</dd></dl>
