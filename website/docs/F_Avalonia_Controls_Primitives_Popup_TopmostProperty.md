...
Defines the <a href="P_Avalonia_Controls_Primitives_Popup_Topmost">Topmost</a> property.
...
```vb
Public Shared ReadOnly TopmostProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val TopmostProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
