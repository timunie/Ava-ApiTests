...
```vb
Protected Overrides NotOverridable Sub OnRemoveOwner ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Controls/ResourceDictionary.cs#L354" title="View the source code">View Source</a>
