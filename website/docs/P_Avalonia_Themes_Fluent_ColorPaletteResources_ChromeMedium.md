...
```vb
Public Property ChromeMedium As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeMedium : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L127" title="View the source code">View Source</a>
