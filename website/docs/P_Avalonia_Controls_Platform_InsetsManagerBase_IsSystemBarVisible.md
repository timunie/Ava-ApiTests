...
```vb
Public Overridable Property IsSystemBarVisible As Boolean?
	Get
	Set
```
</TabItem>
...
override IsSystemBarVisible : Nullable<bool> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/Platform/IInsetsManager.cs#L41" title="View the source code">View Source</a>
...
#### Implements
<a href="P_Avalonia_Controls_Platform_IInsetsManager_IsSystemBarVisible">IInsetsManager.IsSystemBarVisible</a>  
