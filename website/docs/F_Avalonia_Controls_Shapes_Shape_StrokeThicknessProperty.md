...
Defines the <a href="P_Avalonia_Controls_Shapes_Shape_StrokeThickness">StrokeThickness</a> property.
...
```vb
Public Shared ReadOnly StrokeThicknessProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val StrokeThicknessProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
