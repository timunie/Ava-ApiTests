# AddPointerTouchPadGestureMagnifyHandler Method
...
```csharp
public static void AddPointerTouchPadGestureMagnifyHandler(
	Interactive element,
...
```vb
Public Shared Sub AddPointerTouchPadGestureMagnifyHandler ( 
...
```fsharp
static member AddPointerTouchPadGestureMagnifyHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L156" title="View the source code">View Source</a>
