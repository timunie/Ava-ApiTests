...
```csharp
public static void RemoveHoldingHandler(
	Interactive element,
...
```vb
Public Shared Sub RemoveHoldingHandler ( 
...
```fsharp
static member RemoveHoldingHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L189" title="View the source code">View Source</a>
