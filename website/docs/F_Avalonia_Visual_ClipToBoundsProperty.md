...
Defines the <a href="P_Avalonia_Visual_ClipToBounds">ClipToBounds</a> property.
...
```vb
Public Shared ReadOnly ClipToBoundsProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ClipToBoundsProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
