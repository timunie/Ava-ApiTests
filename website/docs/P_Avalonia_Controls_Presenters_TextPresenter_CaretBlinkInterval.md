...
```vb
Public Property CaretBlinkInterval As TimeSpan
	Get
	Set
```
</TabItem>
...
```fsharp
member CaretBlinkInterval : TimeSpan with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Presenters/TextPresenter.cs#L318" title="View the source code">View Source</a>
