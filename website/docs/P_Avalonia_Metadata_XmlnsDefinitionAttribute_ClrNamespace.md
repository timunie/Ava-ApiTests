...
```fsharp
member ClrNamespace : string with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Metadata/XmlnsDefinitionAttribute.cs#L30" title="View the source code">View Source</a>
