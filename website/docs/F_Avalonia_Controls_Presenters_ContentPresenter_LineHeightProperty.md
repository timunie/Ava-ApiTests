...
Defines the <a href="P_Avalonia_Controls_Presenters_ContentPresenter_LineHeight">LineHeight</a> property
...
```vb
Public Shared ReadOnly LineHeightProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val LineHeightProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
