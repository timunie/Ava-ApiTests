...
```vb
Public Event Deactivated As EventHandler(Of ActivatedEventArgs)
```
</TabItem>
...
abstract Deactivated : IEvent<EventHandler<ActivatedEventArgs>,
    ActivatedEventArgs>
override Deactivated : IEvent<EventHandler<ActivatedEventArgs>,
    ActivatedEventArgs>
```
</TabItem>
</Tabs>
...
#### Implements
<a href="E_Avalonia_Controls_ApplicationLifetimes_IActivatableLifetime_Deactivated">IActivatableLifetime.Deactivated</a>  
