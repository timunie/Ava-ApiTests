...
```vb
ReadOnly Property InteractionState As WindowInteractionState
	Get
```
</TabItem>
...
#### Property Value
<a href="T_Avalonia_Win32_Interop_Automation_WindowInteractionState">WindowInteractionState</a>
