...
```vb
Public Property AltMedium As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member AltMedium : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L37" title="View the source code">View Source</a>
