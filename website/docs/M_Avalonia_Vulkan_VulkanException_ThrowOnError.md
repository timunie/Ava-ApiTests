...
```vb
Public Shared Sub ThrowOnError ( 
	funcName As String,
	res As Integer
)
```
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanException.cs#L24" title="View the source code">View Source</a>
