...
```fsharp
static member InvalidateAssemblyCache : 
        name : string -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Platform/AssetLoader.cs#L38" title="View the source code">View Source</a>
