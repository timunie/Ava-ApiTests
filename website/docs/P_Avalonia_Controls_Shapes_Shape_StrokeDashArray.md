...
Gets or sets a collection of <a href="https://learn.microsoft.com/dotnet/api/system.double" target="_blank" rel="noopener noreferrer">Double</a> values that indicate the pattern of dashes and gaps that is used to outline shapes.
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Shapes/Shape.cs#L155" title="View the source code">View Source</a>
