...
```vb
Public Property RegionColor As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member RegionColor : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L157" title="View the source code">View Source</a>
