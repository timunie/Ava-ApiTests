...
```vb
Public ReadOnly Property AccessKey As Char
	Get
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Primitives/AccessText.cs#L47" title="View the source code">View Source</a>
