...
```vb
Public Property CommandModifiers As KeyModifiers
	Get
	Set
```
</TabItem>
...
```fsharp
member CommandModifiers : KeyModifiers with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L110" title="View the source code">View Source</a>
