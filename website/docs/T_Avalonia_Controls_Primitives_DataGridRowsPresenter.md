# DataGridRowsPresenter Class


Used within the template of a <a href="T_Avalonia_Controls_DataGrid">DataGrid</a> to specify the location in the control's visual tree where the rows are to be added.
...
```vb
Public NotInheritable Class DataGridRowsPresenter
	Inherits Panel
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridRowsPresenter__ctor">DataGridRowsPresenter()</a></td>
<td>Initializes a new instance of the DataGridRowsPresenter class</td>
</tr>
</table>
