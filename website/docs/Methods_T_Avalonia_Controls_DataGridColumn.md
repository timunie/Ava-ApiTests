...
<td>When overridden in a derived class, causes the column cell being edited to revert to the unedited value.</td>
</tr>
<tr>
...
<td>Clears the current sort direction</td>
</tr>
<tr>
...
<td>When overridden in a derived class, called when a cell in the column exits editing mode.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_DataGridColumn_GenerateEditingElement">GenerateEditingElement(DataGridCell, Object, ICellEditBinding)</a></td>
<td>When overridden in a derived class, gets an editing element that is bound to the column's <a href="P_Avalonia_Controls_DataGridBoundColumn_Binding">Binding</a> property value.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_DataGridColumn_GenerateElement">GenerateElement(DataGridCell, Object)</a></td>
<td>When overridden in a derived class, gets a read-only element that is bound to the column's <a href="P_Avalonia_Controls_DataGridBoundColumn_Binding">Binding</a> property value.</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_DataGridColumn_GetColumnContainingElement">GetColumnContainingElement(Control)</a></td>
<td>Returns the column which contains the given element</td>
</tr>
<tr>
...
<td>Called by a specific column type when one of its properties changed, and its current cells need to be updated.</td>
</tr>
<tr>
...
<td>When overridden in a derived class, called when a cell in the column enters editing mode.</td>
</tr>
<tr>
...
<td>Called by the DataGrid control when a column asked for its elements to be refreshed, typically because one of its properties changed.</td>
</tr>
<tr>
...
<td>Switches the current state of sort direction</td>
</tr>
<tr>
<td><a href="M_Avalonia_Controls_DataGridColumn_Sort_1">Sort(ListSortDirection)</a></td>
<td>Changes the sort direction of this column</td>
</tr>
<tr>
