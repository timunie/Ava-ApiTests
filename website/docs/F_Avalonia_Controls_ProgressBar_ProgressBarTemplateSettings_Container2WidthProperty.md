...
Defines the <a href="P_Avalonia_Controls_ProgressBar_ProgressBarTemplateSettings_Container2Width">Container2Width</a> property.
...
```vb
Public Shared ReadOnly Container2WidthProperty As DirectProperty(Of ProgressBar.ProgressBarTemplateSettings, Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val Container2WidthProperty: DirectProperty<ProgressBar.ProgressBarTemplateSettings, float>
```
</TabItem>
</Tabs>
