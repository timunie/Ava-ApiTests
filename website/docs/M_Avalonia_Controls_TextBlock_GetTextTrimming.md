...
```vb
Public Shared Function GetTextTrimming ( 
	control As Control
) As TextTrimming
```
</TabItem>
...
```fsharp
static member GetTextTrimming : 
        control : Control -> TextTrimming 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/TextBlock.cs#L471" title="View the source code">View Source</a>
