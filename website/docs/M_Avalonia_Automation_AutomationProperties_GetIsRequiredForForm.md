...
```csharp
public static bool GetIsRequiredForForm(
...
```vb
Public Shared Function GetIsRequiredForForm ( 
...
```fsharp
static member GetIsRequiredForForm : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Automation/AutomationProperties.cs#L330" title="View the source code">View Source</a>
