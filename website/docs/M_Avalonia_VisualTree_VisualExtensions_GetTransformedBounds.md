...
```vb
<ExtensionAttribute>
Public Shared Function GetTransformedBounds ( 
	visual As Visual
) As TransformedBounds?
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
[<ExtensionAttribute>]
static member GetTransformedBounds : 
        visual : Visual -> Nullable<TransformedBounds> 
```
</TabItem>
</Tabs>
...
#### Return Value
<a href="https://learn.microsoft.com/dotnet/api/system.nullable-1" target="_blank" rel="noopener noreferrer">Nullable</a>(<a href="T_Avalonia_VisualTree_TransformedBounds">TransformedBounds</a>)
