...
```fsharp
member OverhangTrailing : float with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/FormattedText.cs#L1315" title="View the source code">View Source</a>
