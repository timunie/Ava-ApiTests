...
Parses a string to return a <a href="T_Avalonia_Animation_IterationCount">IterationCount</a>.
...
```csharp
public static IterationCount Parse(
	string s
)
```
</TabItem>
...
The <a href="T_Avalonia_Animation_IterationCount">IterationCount</a>.
