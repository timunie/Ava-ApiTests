# RemovePointerTouchPadGestureRotateHandler Method
...
```csharp
public static void RemovePointerTouchPadGestureRotateHandler(
	Interactive element,
...
```vb
Public Shared Sub RemovePointerTouchPadGestureRotateHandler ( 
...
```fsharp
static member RemovePointerTouchPadGestureRotateHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L207" title="View the source code">View Source</a>
