...
```vb
Public MustOverride Function GetPreviousCaretCharacterHit ( 
...
```fsharp
abstract GetPreviousCaretCharacterHit : 
...
The previous <a href="T_Avalonia_Media_CharacterHit">CharacterHit</a>.
