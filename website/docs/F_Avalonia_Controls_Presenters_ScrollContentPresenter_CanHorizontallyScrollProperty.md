...
Defines the <a href="P_Avalonia_Controls_Presenters_ScrollContentPresenter_CanHorizontallyScroll">CanHorizontallyScroll</a> property.
...
```vb
Public Shared ReadOnly CanHorizontallyScrollProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val CanHorizontallyScrollProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
