...
```vb
Public Property AutoCapitalization As Boolean
	Get
	Set
```
</TabItem>
...
```fsharp
member AutoCapitalization : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/TextInput/TextInputOptions.cs#L222" title="View the source code">View Source</a>
