...
Gets or sets a <a href="T_Avalonia_Media_PenLineJoin">PenLineJoin</a> enumeration value that specifies the type of join that is used at the vertices of a Shape.
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Shapes/Shape.cs#L191" title="View the source code">View Source</a>
