...
```vb
Public ReadOnly Property AfterPlatformServicesSetupCallback As Action(Of AppBuilder)
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member AfterPlatformServicesSetupCallback : Action<AppBuilder> with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/AppBuilder.cs#L81" title="View the source code">View Source</a>
