...
```csharp
public override bool KeysMatch(
	Object groupKey,
	Object itemKey
)
```
...
```vb
Public Overrides Function KeysMatch ( 
	groupKey As Object,
	itemKey As Object
) As Boolean
```
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/Collections/DataGridGroupDescription.cs#L93" title="View the source code">View Source</a>
