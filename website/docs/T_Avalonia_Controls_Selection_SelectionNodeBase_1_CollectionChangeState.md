...
```fsharp
type CollectionChangeState = class end
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/Selection/SelectionNodeBase.cs" title="View the source code">View Source</a>

<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  SelectionNodeBase(T).CollectionChangeState</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Selection_SelectionNodeBase_1_CollectionChangeState__ctor">SelectionNodeBase(T).CollectionChangeState()</a></td>
<td>Initializes a new instance of the SelectionNodeBase(T).CollectionChangeState class</td>
</tr>
</table>
