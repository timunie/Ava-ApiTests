...
```vb
Protected Overrides Sub OnDragCompleted ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Primitives/TextSelectionHandle.cs#L69" title="View the source code">View Source</a>
