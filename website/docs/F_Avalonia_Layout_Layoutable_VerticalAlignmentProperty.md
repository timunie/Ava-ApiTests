...
Defines the <a href="P_Avalonia_Layout_Layoutable_VerticalAlignment">VerticalAlignment</a> property.
...
```vb
Public Shared ReadOnly VerticalAlignmentProperty As StyledProperty(Of VerticalAlignment)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val VerticalAlignmentProperty: StyledProperty<VerticalAlignment>
```
</TabItem>
</Tabs>
