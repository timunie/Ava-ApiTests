...
```vb
Public Property DisableDefaultApplicationMenuItems As Boolean
	Get
	Set
```
</TabItem>
...
```fsharp
member DisableDefaultApplicationMenuItems : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Native/AvaloniaNativePlatformExtensions.cs#L107" title="View the source code">View Source</a>
