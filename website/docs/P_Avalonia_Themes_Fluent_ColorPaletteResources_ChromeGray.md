...
```vb
Public Property ChromeGray As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeGray : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L112" title="View the source code">View Source</a>
