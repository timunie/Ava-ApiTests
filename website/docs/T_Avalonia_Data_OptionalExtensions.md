...
```vb
<ExtensionAttribute>
Public NotInheritable Class OptionalExtensions
```
</TabItem>
...
[<SealedAttribute>]
[<ExtensionAttribute>]
type OptionalExtensions = class end
```
</TabItem>
</Tabs>
...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  OptionalExtensions</td></tr>
</table>
