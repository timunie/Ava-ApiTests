...
```vb
Public Property PageDown As List(Of KeyGesture)
	Get
	Set
```
</TabItem>
...
```fsharp
member PageDown : List<KeyGesture> with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L130" title="View the source code">View Source</a>
