...
```vb
Public Property AltMediumHigh As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member AltMediumHigh : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L42" title="View the source code">View Source</a>
