...
```csharp
public static void AddTappedHandler(
	Interactive element,
...
```vb
Public Shared Sub AddTappedHandler ( 
...
```fsharp
static member AddTappedHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L126" title="View the source code">View Source</a>
