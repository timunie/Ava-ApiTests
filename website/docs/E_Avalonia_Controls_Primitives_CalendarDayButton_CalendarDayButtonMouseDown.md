...
```vb
Public Event CalendarDayButtonMouseDown As EventHandler(Of PointerPressedEventArgs)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member CalendarDayButtonMouseDown : IEvent<EventHandler<PointerPressedEventArgs>,
...
#### Value
<a href="https://learn.microsoft.com/dotnet/api/system.eventhandler-1" target="_blank" rel="noopener noreferrer">EventHandler</a>(PointerPressedEventArgs)
