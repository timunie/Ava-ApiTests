...
Gets the value of the attached <a href="F_Avalonia_Input_TextInput_TextInputOptions_LowercaseProperty">LowercaseProperty</a>.
...
```vb
Public Shared Function GetLowercase ( 
