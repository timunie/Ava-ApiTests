# AddScrollGestureHandler Method
...
```csharp
public static void AddScrollGestureHandler(
	Interactive element,
...
```vb
Public Shared Sub AddScrollGestureHandler ( 
...
```fsharp
static member AddScrollGestureHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L165" title="View the source code">View Source</a>
