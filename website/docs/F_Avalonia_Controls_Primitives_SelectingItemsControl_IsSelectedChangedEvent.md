...
Event that should be raised by containers when their selection state changes to notify the parent <a href="T_Avalonia_Controls_Primitives_SelectingItemsControl">SelectingItemsControl</a> that their selection state has changed.
