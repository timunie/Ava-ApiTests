...
```vb
Public Shared ReadOnly HeaderTemplateProperty As DirectProperty(Of DataGridColumn, IDataTemplate)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val HeaderTemplateProperty: DirectProperty<DataGridColumn, IDataTemplate>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_DirectProperty_2">DirectProperty</a>(<a href="T_Avalonia_Controls_DataGridColumn">DataGridColumn</a>, <a href="T_Avalonia_Controls_Templates_IDataTemplate">IDataTemplate</a>)
