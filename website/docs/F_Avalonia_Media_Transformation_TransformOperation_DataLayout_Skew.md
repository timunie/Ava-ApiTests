...
public TransformOperation.DataLayout.SkewLayout Skew
```
</TabItem>
<TabItem value="vb" label="VB">
```vb
<FieldOffsetAttribute(0)>
Public Skew As TransformOperation.DataLayout.SkewLayout
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
[<FieldOffsetAttribute(0)>]
val mutable Skew: TransformOperation.DataLayout.SkewLayout
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_Media_Transformation_TransformOperation_DataLayout_SkewLayout">TransformOperation.DataLayout.SkewLayout</a>
