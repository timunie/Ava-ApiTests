# ClearValue&lt;T&gt;(DirectPropertyBase&lt;T&gt;) Method
...
```fsharp
member ClearValue : 
        property : DirectPropertyBase<'T> -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/AvaloniaObject.cs#L174" title="View the source code">View Source</a>
