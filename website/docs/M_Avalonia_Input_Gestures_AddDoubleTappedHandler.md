...
```csharp
public static void AddDoubleTappedHandler(
	Interactive element,
...
```vb
Public Shared Sub AddDoubleTappedHandler ( 
...
```fsharp
static member AddDoubleTappedHandler : 
        element : Interactive * 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Gestures.cs#L132" title="View the source code">View Source</a>
