...
Defines the <a href="P_Avalonia_Media_Pen_Thickness">Thickness</a> property.
...
```vb
Public Shared ReadOnly ThicknessProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ThicknessProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
