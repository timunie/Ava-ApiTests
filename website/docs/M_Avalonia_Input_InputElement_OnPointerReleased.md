...
```vb
Protected Overridable Sub OnPointerReleased ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/InputElement.cs#L608" title="View the source code">View Source</a>
