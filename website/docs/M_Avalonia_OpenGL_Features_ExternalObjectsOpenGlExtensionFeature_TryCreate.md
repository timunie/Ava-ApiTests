...
```csharp
public static ExternalObjectsOpenGlExtensionFeature? TryCreate(
	IGlContext context
)
```
</TabItem>
...
) As ExternalObjectsOpenGlExtensionFeature
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static member TryCreate : 
        context : IGlContext -> ExternalObjectsOpenGlExtensionFeature 
```
</TabItem>
</Tabs>
...
#### Return Value
<a href="T_Avalonia_OpenGL_Features_ExternalObjectsOpenGlExtensionFeature">ExternalObjectsOpenGlExtensionFeature</a>
