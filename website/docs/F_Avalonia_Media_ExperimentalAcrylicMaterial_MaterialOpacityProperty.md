...
Defines the <a href="P_Avalonia_Media_ExperimentalAcrylicMaterial_MaterialOpacity">MaterialOpacity</a> property.
...
```vb
Public Shared ReadOnly MaterialOpacityProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val MaterialOpacityProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
