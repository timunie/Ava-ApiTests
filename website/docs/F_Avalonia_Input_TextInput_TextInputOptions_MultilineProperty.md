...
Defines the <a href="P_Avalonia_Input_TextInput_TextInputOptions_Multiline">Multiline</a> property.
...
```vb
Public Shared ReadOnly MultilineProperty As AttachedProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val MultilineProperty: AttachedProperty<bool>
```
</TabItem>
</Tabs>
