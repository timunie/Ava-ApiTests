...
Defines the <a href="P_Avalonia_Input_TextInput_TextInputOptions_Lowercase">Lowercase</a> property.
...
```vb
Public Shared ReadOnly LowercaseProperty As AttachedProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val LowercaseProperty: AttachedProperty<bool>
```
</TabItem>
</Tabs>
