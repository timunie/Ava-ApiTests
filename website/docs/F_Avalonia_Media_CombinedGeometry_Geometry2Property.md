...
Defines the <a href="P_Avalonia_Media_CombinedGeometry_Geometry2">Geometry2</a> property.
...
```vb
Public Shared ReadOnly Geometry2Property As StyledProperty(Of Geometry)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val Geometry2Property: StyledProperty<Geometry>
```
</TabItem>
</Tabs>
