...
```vb
Public Property OverhangTrailing As Double
	Get
	Set
```
</TabItem>
...
```fsharp
member OverhangTrailing : float with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/TextLineMetrics.cs#L67" title="View the source code">View Source</a>
