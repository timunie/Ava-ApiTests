...
```vb
Protected Overridable Sub OnLoadingRowGroup ( 
...
```fsharp
abstract OnLoadingRowGroup : 
        e : DataGridRowGroupHeaderEventArgs -> unit 
override OnLoadingRowGroup : 
        e : DataGridRowGroupHeaderEventArgs -> unit 
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls.DataGrid/DataGrid.cs#L6018" title="View the source code">View Source</a>
