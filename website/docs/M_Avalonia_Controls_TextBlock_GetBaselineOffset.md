...
```csharp
public static double GetBaselineOffset(
	Control control
)
```
</TabItem>
...
```vb
Public Shared Function GetBaselineOffset ( 
	control As Control
) As Double
```
</TabItem>
...
```fsharp
static member GetBaselineOffset : 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/TextBlock.cs#L384" title="View the source code">View Source</a>
