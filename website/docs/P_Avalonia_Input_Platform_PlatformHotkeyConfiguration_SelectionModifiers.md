...
```vb
Public Property SelectionModifiers As KeyModifiers
	Get
	Set
```
</TabItem>
...
```fsharp
member SelectionModifiers : KeyModifiers with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L112" title="View the source code">View Source</a>
