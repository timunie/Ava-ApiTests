...
Defines the <a href="P_Avalonia_Controls_Primitives_PopupFlyoutBase_OverlayDismissEventPassThrough">OverlayDismissEventPassThrough</a> property
...
```vb
Public Shared ReadOnly OverlayDismissEventPassThroughProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val OverlayDismissEventPassThroughProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
