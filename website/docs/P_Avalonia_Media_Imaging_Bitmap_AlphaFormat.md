...
```vb
Public Overridable ReadOnly Property AlphaFormat As AlphaFormat?
	Get
```
</TabItem>
...
override AlphaFormat : Nullable<AlphaFormat> with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/Imaging/Bitmap.cs#L180" title="View the source code">View Source</a>
