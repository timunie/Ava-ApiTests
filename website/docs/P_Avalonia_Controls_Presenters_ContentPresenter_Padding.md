...
Gets or sets the space between the border and the <a href="P_Avalonia_Controls_Presenters_ContentPresenter_Child">Child</a> control.
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Presenters/ContentPresenter.cs#L388" title="View the source code">View Source</a>
