...
<td>Check to see whether the <a href="T_Avalonia_Animation_KeySpline">KeySpline</a> is valid by looking at its X values.</td>
</tr>
<tr>
<td><a href="M_Avalonia_Animation_KeySpline_Parse">Parse(String, CultureInfo)</a></td>
<td>Parse a <a href="T_Avalonia_Animation_KeySpline">KeySpline</a> from a string. The string needs to contain 4 values in it for the 2 control points.</td>
</tr>
<tr>
