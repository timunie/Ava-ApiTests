...
<table>
<tr>
<td><a href="M_Avalonia_Interactivity_Interactive__ctor">Interactive()</a></td>
<td>Initializes a new instance of the Interactive class</td>
</tr>
</table>
...
<td>Builds an event route for a routed event.</td>
</tr>
<tr>
...
<td>Calls the <a href="M_Avalonia_Visual_OnAttachedToVisualTree">OnAttachedToVisualTree(VisualTreeAttachmentEventArgs)</a> method for this control and all of its visual descendants.<br />(Inherited from <a href="T_Avalonia_Layout_Layoutable">Layoutable</a>)</td>
</tr>
<tr>
...
<td><br />(Inherited from <a href="T_Avalonia_Layout_Layoutable">Layoutable</a>)</td>
</tr>
<tr>
