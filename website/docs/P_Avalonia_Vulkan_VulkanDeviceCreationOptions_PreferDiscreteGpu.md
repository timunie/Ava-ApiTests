...
```vb
Public Property PreferDiscreteGpu As Boolean
	Get
	Set
```
</TabItem>
...
```fsharp
member PreferDiscreteGpu : bool with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Vulkan/VulkanOptions.cs#L60" title="View the source code">View Source</a>
