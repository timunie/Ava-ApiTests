...
```vb
Public Property WholeWordTextActionModifiers As KeyModifiers
	Get
	Set
```
</TabItem>
...
```fsharp
member WholeWordTextActionModifiers : KeyModifiers with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/Platform/PlatformHotkeyConfiguration.cs#L111" title="View the source code">View Source</a>
