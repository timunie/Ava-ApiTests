...
```vb
Public Property ChromeDisabledLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeDisabledLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L107" title="View the source code">View Source</a>
