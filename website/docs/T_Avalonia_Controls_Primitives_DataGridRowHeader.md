# DataGridRowHeader Class


Represents an individual <a href="T_Avalonia_Controls_DataGrid">DataGrid</a> row header.
...
```csharp
[TemplatePartAttribute("PART_Root", typeof(Control))]
...
```vb
<TemplatePartAttribute("PART_Root", GetType(Control))>
<PseudoClassesAttribute(New String() { ... })>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridRowHeader__ctor">DataGridRowHeader()</a></td>
<td>Initializes a new instance of the DataGridRowHeader class.</td>
</tr>
</table>
...
<tr>
<td><a href="P_Avalonia_Controls_Primitives_DataGridRowHeader_AreSeparatorsVisible">AreSeparatorsVisible</a></td>
<td>Gets or sets a value indicating whether the row header separator lines are visible.</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Controls_Primitives_DataGridRowHeader_SeparatorBrush">SeparatorBrush</a></td>
<td> </td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridRowHeader_OnApplyTemplate">OnApplyTemplate(TemplateAppliedEventArgs)</a></td>
<td>Builds the visual tree for the row header when a new template is applied.<br />(Overrides <a href="M_Avalonia_Controls_Primitives_TemplatedControl_OnApplyTemplate">TemplatedControl.OnApplyTemplate(TemplateAppliedEventArgs)</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridRowHeader_OnPointerEntered">OnPointerEntered(PointerEventArgs)</a></td>
...
<tr>
<td><a href="M_Avalonia_Controls_Primitives_DataGridRowHeader_OnPointerExited">OnPointerExited(PointerEventArgs)</a></td>
