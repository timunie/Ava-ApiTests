...
```vb
Public Property ChromeWhite As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member ChromeWhite : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L137" title="View the source code">View Source</a>
