# AreRowDetailsFrozenProperty Field
...
```vb
Public Shared ReadOnly AreRowDetailsFrozenProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val AreRowDetailsFrozenProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
