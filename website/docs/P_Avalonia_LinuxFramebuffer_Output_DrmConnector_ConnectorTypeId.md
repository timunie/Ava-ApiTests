...
```vb
Public ReadOnly Property ConnectorTypeId As UInteger
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
member ConnectorTypeId : uint32 with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Linux/Avalonia.LinuxFramebuffer/Output/DrmBindings.cs#L31" title="View the source code">View Source</a>
