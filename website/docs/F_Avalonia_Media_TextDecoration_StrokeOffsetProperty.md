...
Defines the <a href="P_Avalonia_Media_TextDecoration_StrokeOffset">StrokeOffset</a> property.
...
```vb
Public Shared ReadOnly StrokeOffsetProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val StrokeOffsetProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
