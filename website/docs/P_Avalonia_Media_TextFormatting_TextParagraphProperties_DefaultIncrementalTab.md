...
```fsharp
abstract DefaultIncrementalTab : float with get
override DefaultIncrementalTab : float with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/TextParagraphProperties.cs#L75" title="View the source code">View Source</a>
