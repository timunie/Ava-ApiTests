...
Defines the <a href="P_Avalonia_Visual_OpacityMask">OpacityMask</a> property.
...
```vb
Public Shared ReadOnly OpacityMaskProperty As StyledProperty(Of IBrush)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val OpacityMaskProperty: StyledProperty<IBrush>
```
</TabItem>
</Tabs>
