...
```vb
Public Shared ReadOnly ClipboardCopyModeProperty As StyledProperty(Of DataGridClipboardCopyMode)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val ClipboardCopyModeProperty: StyledProperty<DataGridClipboardCopyMode>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_StyledProperty_1">StyledProperty</a>(<a href="T_Avalonia_Controls_DataGridClipboardCopyMode">DataGridClipboardCopyMode</a>)
