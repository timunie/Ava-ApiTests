...
```vb
Protected Overridable Sub OnPointerEntered ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Input/InputElement.cs#L575" title="View the source code">View Source</a>
