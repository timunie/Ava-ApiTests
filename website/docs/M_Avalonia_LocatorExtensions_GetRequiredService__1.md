# GetRequiredService&lt;T&gt;(IAvaloniaDependencyResolver) Method
...
```vb
<ExtensionAttribute>
Public Shared Function GetRequiredService(Of T) ( 
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/AvaloniaLocator.cs#L139" title="View the source code">View Source</a>
