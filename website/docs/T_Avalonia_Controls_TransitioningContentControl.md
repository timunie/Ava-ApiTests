...
Displays <a href="P_Avalonia_Controls_ContentControl_Content">Content</a> according to an <a href="T_Avalonia_Controls_Templates_IDataTemplate">IDataTemplate</a>, using a <a href="P_Avalonia_Controls_TransitioningContentControl_PageTransition">PageTransition</a> to move between the old and new content.
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_TransitioningContentControl__ctor">TransitioningContentControl()</a></td>
<td>Initializes a new instance of the TransitioningContentControl class</td>
</tr>
</table>
...
<td>Gets or sets a value indicating whether the control will be animated in the reverse direction.</td>
</tr>
<tr>
...
<td>Gets or sets the animation played when content appears and disappears.</td>
</tr>
<tr>
...
<td>Raised when the old content isn't needed anymore by the control, because the transition has completed.</td>
</tr>
<tr>
