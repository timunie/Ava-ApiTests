...
```vb
Public Property RenderTransformOrigin As RelativePoint
	Get
	Set
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Visual.cs#L287" title="View the source code">View Source</a>
