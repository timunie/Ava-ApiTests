...
```vb
Public Overridable Sub OnMessage ( 
	message As Object
)
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Rendering/Composition/CompositionCustomVisualHandler.cs#L17" title="View the source code">View Source</a>
