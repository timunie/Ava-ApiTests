...
<td>Gets or sets the Uniform Resource Identifier (URI) automatically navigated to when the <a href="T_Avalonia_Controls_HyperlinkButton">HyperlinkButton</a> is clicked.</td>
</tr>
<tr>
