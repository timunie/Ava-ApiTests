...
```csharp
public virtual ReadOnlyMemory<char> Text { get; }
```
</TabItem>
<TabItem value="vb" label="VB">
```vb
Public Overridable ReadOnly Property Text As ReadOnlyMemory(Of Char)
	Get
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextFormatting/TextRun.cs#L22" title="View the source code">View Source</a>
