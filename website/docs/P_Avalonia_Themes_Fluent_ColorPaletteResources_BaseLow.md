...
```vb
Public Property BaseLow As Color
	Get
	Set
```
</TabItem>
...
```fsharp
member BaseLow : Color with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Themes.Fluent/ColorPaletteResources.Properties.cs#L57" title="View the source code">View Source</a>
