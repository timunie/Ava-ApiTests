# IsPropertyNameVisibleProperty Field
...
```vb
Public Shared ReadOnly IsPropertyNameVisibleProperty As StyledProperty(Of Boolean)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val IsPropertyNameVisibleProperty: StyledProperty<bool>
```
</TabItem>
</Tabs>
