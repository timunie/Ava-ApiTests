...
<table>
<tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  AvaloniaObject  →  Animatable  →  StyledElement  →  Visual  →  Layoutable  →  Interactive  →  InputElement  →  <a href="T_Avalonia_Controls_Control">Control</a>  →  <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>  →  Sector</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Controls_Shapes_Sector__ctor">Sector</a></td>
<td>Initializes a new instance of the Sector class</td>
</tr>
</table>
...
<td>Gets a value that represents the Geometry of the shape.<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
<td>DesiredSize</td>
...
<td>Gets or sets the IBrush that specifies how the shape's interior is painted.<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
<td>FlowDirection</td>
<td><br />(Inherited from Visual)</td>
...
<td>Gets a value that represents the final rendered Geometry of the shape.<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Controls_Shapes_Sector_StartAngle">StartAngle</a></td>
<td>Gets or sets the angle at which the sector's arc starts, in degrees.</td>
</tr>
<tr>
...
<td>Gets or sets the IBrush that specifies how the shape's outline is painted.<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
...
<td>Gets or sets a PenLineJoin enumeration value that specifies the type of join that is used at the vertices of a Shape.<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
<td><a href="P_Avalonia_Controls_Shapes_Shape_StrokeLineCap">StrokeLineCap</a></td>
<td>Gets or sets a PenLineCap enumeration value that describes the shape at the ends of a line.<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
...
<tr>
<td><a href="P_Avalonia_Controls_Shapes_Sector_SweepAngle">SweepAngle</a></td>
<td>Gets or sets the angle, in degrees, added to the <a href="P_Avalonia_Controls_Shapes_Sector_StartAngle">StartAngle</a> defining where the sector's arc ends. A positive value is clockwise, negative is counter-clockwise.</td>
</tr>
<tr>
<td>TabIndex</td>
<td><br />(Inherited from InputElement)</td>
...
<tr>
<td><a href="M_Avalonia_Controls_Shapes_Sector_CreateDefiningGeometry">CreateDefiningGeometry</a></td>
<td>Creates the shape's defining geometry.<br />(Overrides <a href="M_Avalonia_Controls_Shapes_Shape_CreateDefiningGeometry">Shape.CreateDefiningGeometry()</a>)</td>
</tr>
<tr>
<td>EndInit</td>
<td><br />(Inherited from StyledElement)</td>
...
<td>Called when the underlying Geometry changed<br />(Inherited from <a href="T_Avalonia_Controls_Shapes_Shape">Shape</a>)</td>
</tr>
<tr>
