...
```csharp
public static Bitmap DecodeToHeight(
	Stream stream,
	int height,
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/Imaging/Bitmap.cs#L38" title="View the source code">View Source</a>
