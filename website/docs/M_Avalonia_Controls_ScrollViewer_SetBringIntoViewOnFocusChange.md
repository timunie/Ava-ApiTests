...
```vb
Public Shared Sub SetBringIntoViewOnFocusChange ( 
	control As Control,
	value As Boolean
)
```
...
```fsharp
static member SetBringIntoViewOnFocusChange : 
        control : Control * 
        value : bool -> unit 
```
</TabItem>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/srcAvalonia.Controls/ScrollViewer.cs#L459" title="View the source code">View Source</a>
