...
```vb
Public Shared ReadOnly Property CharacterEllipsis As TextTrimming
	Get
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static member CharacterEllipsis : TextTrimming with get
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Base/Media/TextTrimming.cs#L21" title="View the source code">View Source</a>
