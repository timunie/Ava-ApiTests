...
Defines the <a href="P_Avalonia_Media_Rotate3DTransform_AngleZ">AngleZ</a> property.
...
```vb
Public Shared ReadOnly AngleZProperty As StyledProperty(Of Double)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val AngleZProperty: StyledProperty<float>
```
</TabItem>
</Tabs>
