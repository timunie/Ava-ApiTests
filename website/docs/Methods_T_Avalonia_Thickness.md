...
<td>Returns a hash code for a <a href="T_Avalonia_Thickness">Thickness</a>.<br />(Overrides <a href="https://learn.microsoft.com/dotnet/api/system.valuetype.gethashcode" target="_blank" rel="noopener noreferrer">ValueType.GetHashCode()</a>)</td>
</tr>
<tr>
...
<td>Parses a <a href="T_Avalonia_Thickness">Thickness</a> string.</td>
</tr>
<tr>
