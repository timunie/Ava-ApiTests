...
```fsharp
member LetterSpacing : float with get, set
```
</TabItem>
</Tabs>
...
<a href="https://github.com/AvaloniaUI/Avalonia/tree/master/src/Avalonia.Controls/Presenters/TextPresenter.cs#L244" title="View the source code">View Source</a>
