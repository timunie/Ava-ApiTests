...
Defines the <a href="P_Avalonia_Controls_Presenters_ScrollContentPresenter_HorizontalSnapPointsAlignment">HorizontalSnapPointsAlignment</a> property.
...
```vb
Public Shared ReadOnly HorizontalSnapPointsAlignmentProperty As StyledProperty(Of SnapPointsAlignment)
```
</TabItem>
<TabItem value="fsharp" label="F#">
```fsharp
static val HorizontalSnapPointsAlignmentProperty: StyledProperty<SnapPointsAlignment>
```
</TabItem>
</Tabs>
...
#### Field Value
<a href="T_Avalonia_StyledProperty_1">StyledProperty</a>(<a href="T_Avalonia_Controls_Primitives_SnapPointsAlignment">SnapPointsAlignment</a>)
