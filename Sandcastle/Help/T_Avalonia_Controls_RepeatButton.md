...
<td>Initializes a new instance of the RepeatButton class</td></tr>
</table>
...
<td><br />(Overrides <a href="M_Avalonia_Controls_Button_OnKeyDown">Button.OnKeyDown(KeyEventArgs)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_RepeatButton_OnKeyUp">OnKeyUp(KeyEventArgs)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Controls_Button_OnKeyUp">Button.OnKeyUp(KeyEventArgs)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Controls_Button_OnPointerPressed">Button.OnPointerPressed(PointerPressedEventArgs)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_RepeatButton_OnPointerReleased">OnPointerReleased(PointerReleasedEventArgs)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Controls_Button_OnPointerReleased">Button.OnPointerReleased(PointerReleasedEventArgs)</a>)</td></tr>
<tr>
