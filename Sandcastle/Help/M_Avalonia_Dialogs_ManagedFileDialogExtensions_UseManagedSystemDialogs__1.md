---
title:UseManagedSystemDialogs&lt;TWindow&gt;(AppBuilder) Method
description: Autogenertated API Reference page
hide_table_of_contents: false
---
# UseManagedSystemDialogs&lt;TWindow&gt;(AppBuilder) Method
...
**C#**
``` C#
public static AppBuilder UseManagedSystemDialogs<TWindow>(
...
``` F#
[<ExtensionAttribute>]
static member UseManagedSystemDialogs : 
        builder : AppBuilder -> AppBuilder  when 'TWindow : new() and Window
```
