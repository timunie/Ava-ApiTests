---
title:ShadowDepthProperty Field
...
**VB**
``` VB
Public Shared ReadOnly ShadowDepthProperty As StyledProperty(Of Double)
```
**F#**
``` F#
static val ShadowDepthProperty: StyledProperty<float>
```
