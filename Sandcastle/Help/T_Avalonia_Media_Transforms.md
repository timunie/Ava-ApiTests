...
Public NotInheritable Class Transforms
	Inherits AvaloniaList(Of Transform)
```
**F#**
``` F#
[<SealedAttribute>]
type Transforms = 
    class
        inherit AvaloniaList<Transform>
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList</a>(<a href="T_Avalonia_Media_Transform">Transform</a>)  →  Transforms</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Media_Transforms__ctor">Transforms()</a></td>
<td>Initializes a new instance of the Transforms class</td></tr>
</table>
