...
**C#**
``` C#
public abstract class TransitionBase : AvaloniaObject, 
	ITransition
```
**VB**
``` VB
...
<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_AvaloniaObject">AvaloniaObject</a>  →  TransitionBase</td></tr>
...
<table>
<tr>
<td><a href="M_Avalonia_Animation_TransitionBase__ctor">TransitionBase()</a></td>
<td>Initializes a new instance of the TransitionBase class</td></tr>
</table>
