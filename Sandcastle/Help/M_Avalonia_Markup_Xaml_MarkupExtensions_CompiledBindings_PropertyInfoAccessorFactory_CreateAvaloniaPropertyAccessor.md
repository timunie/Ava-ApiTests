---
title:CreateAvaloniaPropertyAccessor Method
...
**C#**
``` C#
public static IPropertyAccessor CreateAvaloniaPropertyAccessor(
...
**VB**
``` VB
Public Shared Function CreateAvaloniaPropertyAccessor ( 
...
**F#**
``` F#
static member CreateAvaloniaPropertyAccessor : 
