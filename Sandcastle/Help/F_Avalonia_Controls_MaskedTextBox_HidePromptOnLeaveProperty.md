---
title:HidePromptOnLeaveProperty Field
...
**VB**
``` VB
Public Shared ReadOnly HidePromptOnLeaveProperty As StyledProperty(Of Boolean)
```
**F#**
``` F#
static val HidePromptOnLeaveProperty: StyledProperty<bool>
```
