...
**VB**
``` VB
Public NotInheritable Class PathFigures
	Inherits AvaloniaList(Of PathFigure)
```
**F#**
``` F#
[<SealedAttribute>]
type PathFigures = 
    class
        inherit AvaloniaList<PathFigure>
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList</a>(<a href="T_Avalonia_Media_PathFigure">PathFigure</a>)  →  PathFigures</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Media_PathFigures__ctor">PathFigures()</a></td>
<td>Initializes a new instance of the PathFigures class</td></tr>
</table>
...
<td><br />(Inherited from <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList(T)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Media_PathFigures_Parse">Parse(String)</a></td>
<td> </td></tr>
<tr>
