---
title:ManagedFileChooserItemViewModel Class
...
**F#**
``` F#
type ManagedFileChooserItemViewModel = 
    class
        inherit AvaloniaDialogsInternalViewModelBase
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_Dialogs_Internal_AvaloniaDialogsInternalViewModelBase">AvaloniaDialogsInternalViewModelBase</a>  →  ManagedFileChooserItemViewModel</td></tr>
</table>
...
<td>Initializes a new instance of the ManagedFileChooserItemViewModel class</td></tr>
<tr>
