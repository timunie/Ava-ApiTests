---
title:GetSelfAndLogicalAncestors Method
...
**C#**
``` C#
public static IEnumerable<ILogical> GetSelfAndLogicalAncestors(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetSelfAndLogicalAncestors ( 
	logical As ILogical
...
``` F#
[<ExtensionAttribute>]
static member GetSelfAndLogicalAncestors : 
...
#### Parameters
<dl><dt>  <a href="T_Avalonia_LogicalTree_ILogical">ILogical</a></dt><dd> </dd></dl>
