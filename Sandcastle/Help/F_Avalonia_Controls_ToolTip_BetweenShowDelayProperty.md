---
title:BetweenShowDelayProperty Field
...
**VB**
``` VB
Public Shared ReadOnly BetweenShowDelayProperty As AttachedProperty(Of Integer)
```
**F#**
``` F#
static val BetweenShowDelayProperty: AttachedProperty<int>
```
