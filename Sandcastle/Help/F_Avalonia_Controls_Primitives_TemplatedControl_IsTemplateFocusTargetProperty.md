---
title:IsTemplateFocusTargetProperty Field
...
**VB**
``` VB
Public Shared ReadOnly IsTemplateFocusTargetProperty As AttachedProperty(Of Boolean)
```
**F#**
``` F#
static val IsTemplateFocusTargetProperty: AttachedProperty<bool>
```
