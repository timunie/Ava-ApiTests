...
<td>Initializes a new instance of the Classes class</td></tr>
<tr>
...
<td><br />(Inherited from <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList(T)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_Add">AvaloniaList(T).Add(T)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Classes_AddRange">AddRange(IEnumerable(String))</a></td>
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_AddRange">AvaloniaList(T).AddRange(IEnumerable(T))</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Classes_Clear">Clear()</a></td>
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_Clear">AvaloniaList(T).Clear()</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_Insert">AvaloniaList(T).Insert(Int32, T)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Classes_InsertRange">InsertRange(Int32, IEnumerable(String))</a></td>
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_InsertRange">AvaloniaList(T).InsertRange(Int32, IEnumerable(T))</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_Remove">AvaloniaList(T).Remove(T)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Classes_RemoveAll">RemoveAll(IEnumerable(String))</a></td>
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_RemoveAll">AvaloniaList(T).RemoveAll(IEnumerable(T))</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Classes_RemoveAt">RemoveAt(Int32)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_RemoveAt">AvaloniaList(T).RemoveAt(Int32)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Classes_RemoveRange">RemoveRange(Int32, Int32)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Collections_AvaloniaList_1_RemoveRange">AvaloniaList(T).RemoveRange(Int32, Int32)</a>)</td></tr>
<tr>
...
<td><br />(Defined by <a href="T_Avalonia_Controls_PseudolassesExtensions">PseudolassesExtensions</a>)</td></tr>
<tr>
