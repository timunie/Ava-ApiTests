---
title:BindingExpressionBase Class
...
Public MustInherit Class BindingExpressionBase
	Implements IDisposable, ISetterInstance
```
**F#**
``` F#
...
<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  BindingExpressionBase</td></tr>
...
<table>
<tr>
<td><a href="M_Avalonia_Data_BindingExpressionBase_Dispose">Dispose()</a></td>
<td>Releases all resources used by the BindingExpressionBase</td></tr>
<tr>
