---
title:RenderTargetDrawingContextProperties Structure
description: Autogenertated API Reference page
hide_table_of_contents: false
---
# RenderTargetDrawingContextProperties Structure
...
**VB**
``` VB
Public Structure RenderTargetDrawingContextProperties
```
**F#**
``` F#
[<SealedAttribute>]
type RenderTargetDrawingContextProperties = 
    struct
        inherit ValueType
    end
```
