---
title:AddTextInputMethodClientRequeryRequestedHandler Method
...
**C#**
``` C#
public static void AddTextInputMethodClientRequeryRequestedHandler(
	Interactive element,
...
**VB**
``` VB
Public Shared Sub AddTextInputMethodClientRequeryRequestedHandler ( 
...
**F#**
``` F#
static member AddTextInputMethodClientRequeryRequestedHandler : 
        element : Interactive * 
