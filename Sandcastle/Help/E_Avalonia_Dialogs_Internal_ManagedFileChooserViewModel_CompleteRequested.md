...
**VB**
``` VB
Public Event CompleteRequested As Action(Of String())
```
**F#**
``` F#
member CompleteRequested : IEvent<Action<string[]>,
    EventArgs>
```
...
#### Value
<a href="https://learn.microsoft.com/dotnet/api/system.action-1" target="_blank" rel="noopener noreferrer">Action</a>(<a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a>[])
