---
title:AvaloniaList&lt;T&gt;.Enumerator Structure
...
<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.valuetype" target="_blank" rel="noopener noreferrer">ValueType</a>  →  AvaloniaList(T).Enumerator</td></tr>
...
<td>Initializes a new instance of the AvaloniaList(T).Enumerator class</td></tr>
</table>
...
<td>Releases all resources used by the AvaloniaList(T).Enumerator</td></tr>
<tr>
