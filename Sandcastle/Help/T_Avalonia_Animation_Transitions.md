...
Public NotInheritable Class Transitions
	Inherits AvaloniaList(Of ITransition)
```
**F#**
``` F#
[<SealedAttribute>]
type Transitions = 
    class
        inherit AvaloniaList<ITransition>
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_Avalonia_Collections_AvaloniaList_1">AvaloniaList</a>(<a href="T_Avalonia_Animation_ITransition">ITransition</a>)  →  Transitions</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Animation_Transitions__ctor">Transitions()</a></td>
<td>Initializes a new instance of the Transitions class</td></tr>
</table>
