---
title:DataContextProperty Field
...
**VB**
``` VB
Public Shared ReadOnly DataContextProperty As AttachedProperty(Of Object)
```
**F#**
``` F#
static val DataContextProperty: AttachedProperty<Object>
```
