---
title:AutoSafeAreaPaddingProperty Field
...
**VB**
``` VB
Public Shared ReadOnly AutoSafeAreaPaddingProperty As AttachedProperty(Of Boolean)
```
**F#**
``` F#
static val AutoSafeAreaPaddingProperty: AttachedProperty<bool>
```
