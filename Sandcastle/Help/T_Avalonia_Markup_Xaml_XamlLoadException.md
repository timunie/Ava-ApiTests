...
**F#**
``` F#
type XamlLoadException = 
    class
        inherit Exception
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  XamlLoadException</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Markup_Xaml_XamlLoadException__ctor">XamlLoadException()</a></td>
<td>Initializes a new instance of the XamlLoadException class</td></tr>
<tr>
<td><a href="M_Avalonia_Markup_Xaml_XamlLoadException__ctor_3">XamlLoadException(String)</a></td>
<td>Initializes a new instance of the XamlLoadException class</td></tr>
<tr>
<td><a href="M_Avalonia_Markup_Xaml_XamlLoadException__ctor_1">XamlLoadException(SerializationInfo, StreamingContext)</a></td>
<td>Initializes a new instance of the XamlLoadException class<br /><strong>Obsolete.</strong></td></tr>
<tr>
<td><a href="M_Avalonia_Markup_Xaml_XamlLoadException__ctor_2">XamlLoadException(String, Exception)</a></td>
<td>Initializes a new instance of the XamlLoadException class</td></tr>
</table>
