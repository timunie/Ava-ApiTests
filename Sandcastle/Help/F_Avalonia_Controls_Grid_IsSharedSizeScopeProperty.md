---
title:IsSharedSizeScopeProperty Field
...
**VB**
``` VB
Public Shared ReadOnly IsSharedSizeScopeProperty As AttachedProperty(Of Boolean)
```
**F#**
``` F#
static val IsSharedSizeScopeProperty: AttachedProperty<bool>
```
