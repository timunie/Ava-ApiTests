...
<td>Initializes a new instance of the Control class</td></tr>
</table>
...
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnAttachedToVisualTreeCore">InputElement.OnAttachedToVisualTreeCore(VisualTreeAttachmentEventArgs)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnDetachedFromVisualTreeCore">InputElement.OnDetachedFromVisualTreeCore(VisualTreeAttachmentEventArgs)</a>)</td></tr>
<tr>
<td><a href="M_Avalonia_Controls_Control_OnGotFocus">OnGotFocus(GotFocusEventArgs)</a></td>
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnGotFocus">InputElement.OnGotFocus(GotFocusEventArgs)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnKeyUp">InputElement.OnKeyUp(KeyEventArgs)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnLostFocus">InputElement.OnLostFocus(RoutedEventArgs)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnPointerReleased">InputElement.OnPointerReleased(PointerReleasedEventArgs)</a>)</td></tr>
<tr>
...
<td><br />(Overrides <a href="M_Avalonia_Input_InputElement_OnPropertyChanged">InputElement.OnPropertyChanged(AvaloniaPropertyChangedEventArgs)</a>)</td></tr>
<tr>
