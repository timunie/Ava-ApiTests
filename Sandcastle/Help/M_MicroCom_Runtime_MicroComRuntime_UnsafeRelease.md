---
title:UnsafeRelease Method
description: Autogenertated API Reference page
hide_table_of_contents: false
---
# UnsafeRelease Method
...
**C#**
``` C#
public static void UnsafeRelease(
...
``` VB
<ExtensionAttribute>
Public Shared Sub UnsafeRelease ( 
	unknown As IUnknown
)
```
**F#**
``` F#
[<ExtensionAttribute>]
static member UnsafeRelease : 
        unknown : IUnknown -> unit 
```
