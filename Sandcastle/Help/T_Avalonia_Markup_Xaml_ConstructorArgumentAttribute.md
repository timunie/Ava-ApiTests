---
title:ConstructorArgumentAttribute Class
...
[<SealedAttribute>]
[<AttributeUsageAttribute(AttributeTargets.Property)>]
type ConstructorArgumentAttribute = 
    class
        inherit Attribute
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.attribute" target="_blank" rel="noopener noreferrer">Attribute</a>  →  ConstructorArgumentAttribute</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_Avalonia_Markup_Xaml_ConstructorArgumentAttribute__ctor">ConstructorArgumentAttribute(String)</a></td>
<td>Initializes a new instance of the ConstructorArgumentAttribute class</td></tr>
</table>
