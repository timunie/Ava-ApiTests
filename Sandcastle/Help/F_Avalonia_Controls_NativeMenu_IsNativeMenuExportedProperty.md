---
title:IsNativeMenuExportedProperty Field
...
**VB**
``` VB
Public Shared ReadOnly IsNativeMenuExportedProperty As AttachedProperty(Of Boolean)
```
**F#**
``` F#
static val IsNativeMenuExportedProperty: AttachedProperty<bool>
```
