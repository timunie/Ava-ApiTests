...
namespace Avalonia.Sandcastle.PresentationStyles.AvaloniaMarkdown
{
    ...
    public class AvaloniaMarkdownTransformation : TopicTransformationCore
    {
        ...
        {
            var title = !this.IsMamlTopic ? this.ApiTopicTitle(false, true) : this.MamlTopicTitle();
            
            pageTemplate = LoadTemplateFile(this.TopicTemplatePath, new []{("@title@", title.ToString())});
